    ...
    {
      {
        ...
        new_nameseq = (struct nameseq *)tmp;
        new_nameseq->name = concat(state->arname, mem, (char *)")");
        new_nameseq->next = state->chain;
        state->chain = new_nameseq;
        (state->n)++;
      }
    }
    return (0L);
...
void file_impossible(char *filename)
{
  ...
  register unsigned int hash;
  register struct directory *dir;
  register struct dirfile *new_dirfile;
  char *dirname;
  char *slash;
  void *tmp;
  char *tmp___0;
...

  {
    ...
    }
    {
      ...
      new_dirfile = (struct dirfile *)tmp___3;
      new_dirfile->next = *((dir->contents)->files + hash);
      *((dir->contents)->files + hash) = new_dirfile;
      new_dirfile->name = xstrdup((char const *)filename);
      new_dirfile->impossible = (char)1;
    }
    return;
  }
}
        ...
        {
          {
            tmp___6 = define_variable_in_set(*(envp + i), (unsigned int)(ep - *(envp + i)),
                                             ...
                                             (struct floc const *)((struct floc *)0));
            tmp___6->v_export = (enum variable_export)0;
          }
        }
        i++;
      }
...
static void define_makeflags(int all, int makefile)
{
...

  {
    ...
    *p = (char)'\000';
    ...
    if (!all)
    {
      v->v_export = (enum variable_export)0;
    }
    return;
  }
}
              ...
              if (tmp___81 == 0)
              {
                ...
                }
                {
                  ...
                  while_continue___7: /* CIL Label */;
                    ...
                    {
                      v___0->v_export = (enum variable_export)1;
                      p = find_next_token(&p2, &len___2);
                    }
                  }
                while_break___7: /* CIL Label */;
...

  {
    ...
    }
    {
      ...
      while_continue: /* CIL Label */;
        ...
        {
          tmp___1 = glob((char const *)old->name, (1 << 4) | (1 << 9), (int (*)(char const *, int))((void *)0),
                         &gl);
        }
        {
          if (tmp___1 == 0)
                                        ...
                                        struct variable_set *set, struct floc const *flocp)
{
...

  {
    ...
    v->per_target = 0U;
    v->append = 0U;
    v->v_export = (enum variable_export)3;
...

  {
    ...
    }
    {
      v = define_variable_in_set((char *)"MAKEFILES", 9U, (char *)"", (enum variable_origin)0,
                                 0, current_variable_set_list->set, (struct floc const *)((struct floc *)0));
      v->v_export = (enum variable_export)2;
            ...
            v = *(set->table + i);
            {
              ...
              while_continue___3: /* CIL Label */;
                ...
                }
                {
                  ...
                  if ((unsigned int)v->v_export == 0U)
                  {
                    goto case_0;
                  }
                  if ((unsigned int)v->v_export == 1U)
                  {
                    goto case_1;
                  }
                  if ((unsigned int)v->v_export == 2U)
                  {
                    goto case_2;
                  }
                  goto switch_break;
...
static size_t read_alias_file(char const *fname, int fname_len)
{
...

  {
    ...
    {
      {
        qsort((void *)map, nmap, sizeof(struct alias_map), (int (*)(void const *, void const *))(&alias_compare));
      }
    }
    return (added);
  }
