...
merge=/debop_script/mkdir_d/path_generator/merge_bin_gcov_files.sh
getbin=/debop_script/mkdir_d/path_generator/get_bin_gcov_file.sh
...
do
    test_name=${testf##*/} 
    timeout 1s ${testf} $CURRDIR/tmp/$PROGRAM ${OUTDIR} 1 ${CURRDIR}/tmp/input.origin
