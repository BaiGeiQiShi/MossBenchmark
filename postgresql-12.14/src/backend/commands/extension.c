...
pg_extension_config_dump(PG_FUNCTION_ARGS)
{
  ...
  else
  {
    ...
    a = array_set(a, 1, &arrayIndex, elementDatum, false, -1                    , sizeof(Oid) /* OID's typlen */, true /* OID's typbyval */, 'i' /* OID's typalign */);
  }
  ...
  else
  {
    ...
    a = array_set(a, 1, &arrayIndex, elementDatum, false, -1                    , -1 /* TEXT's typlen */, false /* TEXT's typbyval */, 'i' /* TEXT's typalign */);
  }
