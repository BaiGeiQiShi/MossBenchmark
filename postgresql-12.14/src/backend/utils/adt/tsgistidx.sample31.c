...
gtsvector_consistent(PG_FUNCTION_ARGS)
{
  ...
  *recheck = true;
  ...
  { /* only leaf pages */
    ...
    PG_RETURN_BOOL(TS_execute(GETQUERY(query), (void *)&chkval, TS_EXEC_PHRASE_NO_POS | TS_EXEC_CALC_NOT, checkcondition_arr));
  }
}
