...
win1250_to_mic(PG_FUNCTION_ARGS)
{
  ...
  latin2mic_with_table(src, dest, len, LC_ISO8859_2, PG_WIN1250, win1250_2_iso88592);
...
mic_to_win1250(PG_FUNCTION_ARGS)
{
  ...
  mic2latin_with_table(src, dest, len, LC_ISO8859_2, PG_WIN1250, iso88592_2_win1250);
