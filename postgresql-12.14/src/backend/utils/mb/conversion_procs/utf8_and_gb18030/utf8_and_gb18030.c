...
gb18030_to_utf8(PG_FUNCTION_ARGS)
{
  ...
  LocalToUtf(src, len, dest, &gb18030_to_unicode_tree, NULL, 0, conv_18030_to_utf8, PG_GB18030);
...
utf8_to_gb18030(PG_FUNCTION_ARGS)
{
  ...
  UtfToLocal(src, len, dest, &gb18030_from_unicode_tree, NULL, 0, conv_utf8_to_18030, PG_GB18030);
