...
utf8_to_koi8r(PG_FUNCTION_ARGS)
{
  ...
  UtfToLocal(src, len, dest, &koi8r_from_unicode_tree, NULL, 0, NULL, PG_KOI8R);
...
koi8r_to_utf8(PG_FUNCTION_ARGS)
{
  ...
  LocalToUtf(src, len, dest, &koi8r_to_unicode_tree, NULL, 0, NULL, PG_KOI8R);
...
utf8_to_koi8u(PG_FUNCTION_ARGS)
{
  ...
  UtfToLocal(src, len, dest, &koi8u_from_unicode_tree, NULL, 0, NULL, PG_KOI8U);
...
koi8u_to_utf8(PG_FUNCTION_ARGS)
{
  ...
  LocalToUtf(src, len, dest, &koi8u_to_unicode_tree, NULL, 0, NULL, PG_KOI8U);
