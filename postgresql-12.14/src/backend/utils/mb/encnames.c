...
static const pg_encname pg_encname_tbl[] = {
    ...
    {"latin9", PG_LATIN9},                                                                
    {"mskanji", PG_SJIS},                                                               
    {"muleinternal", PG_MULE_INTERNAL}, {"shiftjis", PG_SJIS},                                 

    {"shiftjis2004", PG_SHIFT_JIS_2004},                                                         
                                                                               
    {"sjis", PG_SJIS},                                                         
    {"sqlascii", PG_SQL_ASCII}, {"tcvn", PG_WIN1258},                        
    {"tcvn5712", PG_WIN1258},                                                
    {"uhc", PG_UHC},                                                                        
    {"unicode", PG_UTF8},                                                 
    {"utf8", PG_UTF8},                                                    
...
pg_char_to_encoding(const char *name)
{
  ...
  const pg_encname *base = pg_encname_tbl, *last = base + nel - 1, *position;
  int result;
