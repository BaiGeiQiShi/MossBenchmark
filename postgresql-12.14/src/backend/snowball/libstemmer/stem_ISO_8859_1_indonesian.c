...
#endif
  extern int
  indonesian_ISO_8859_1_stem(struct SN_env *z);
#ifdef __cplusplus
}
#endif
static int
...
extern "C"
{
  ...
  indonesian_ISO_8859_1_create_env(void);
  extern void
  indonesian_ISO_8859_1_close_env(struct SN_env *z);
...
r_KER(struct SN_env *z)
{ /* forwardmode */
  if (out_grouping(z, g_vowel, 97, 117, 0))
  {
