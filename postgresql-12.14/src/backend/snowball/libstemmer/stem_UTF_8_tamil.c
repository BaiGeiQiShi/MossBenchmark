...
#endif
  extern int
  tamil_UTF_8_stem(struct SN_env *z);
#ifdef __cplusplus
}
#endif
static int
r_has_min_length(struct SN_env *z);
static int
r_remove_common_word_endings(struct SN_env *z);
static int
r_remove_tense_suffixes(struct SN_env *z);
static int
r_remove_tense_suffix(struct SN_env *z);
static int
r_fix_endings(struct SN_env *z);
static int
r_fix_ending(struct SN_env *z);
static int
r_fix_va_start(struct SN_env *z);
static int
r_remove_vetrumai_urupukal(struct SN_env *z);
static int
r_remove_um(struct SN_env *z);
static int
r_remove_command_suffixes(struct SN_env *z);
static int
r_remove_pronoun_prefixes(struct SN_env *z);
static int
r_remove_question_prefixes(struct SN_env *z);
static int
r_remove_question_suffixes(struct SN_env *z);
static int
r_remove_plural_suffix(struct SN_env *z);
#ifdef __cplusplus
extern "C"
{
#endif
  ...
  tamil_UTF_8_create_env(void);
  extern void
  tamil_UTF_8_close_env(struct SN_env *z);
...
{ /* forwardmode */
  if (!(len_utf8(z->p) > 4))
  {
    return 0; /* $(<integer expression> > <integer expression>), line 100 */
  }
  return 1;
}
...
{                /* forwardmode */
  ...
  if (!(eq_s(z, 3, s_12)))
  {
    return 0; /* literal, line 115 */
  }
  if (!(find_among(z, a_0, 10)))
  {
    return 0; /* among, line 115 */
  }
  if (!(eq_s(z, 3, s_13)))
  {
    return 0; /* literal, line 115 */
...
{ /* forwardmode */
  if (!(len_utf8(z->p) > 3))
  {
    return 0; /* $(<integer expression> > <integer expression>), line 121 */
  }
  z->lb = z->c;
  z->c = z->l; /* backwards, line 122 */
  ...
  lab8:
    ...
    if (!(z->B[1]))
    {
      goto lab9; /* Boolean test found_vetrumai_urupu, line 136 */
    }
    z->ket = z->c; /* [, line 136 */
    if (!(eq_s_b(z, 12, s_24)))
    {
      goto lab9; /* literal, line 136 */
    }
    {
      int m_test4 = z->l - z->c; /* test, line 136 */
      {
        int m5 = z->l - z->c;
        (void)m5; /* not, line 136 */
        if (!(eq_s_b(z, 3, s_25)))
        {
          goto lab10; /* literal, line 136 */
        }
        goto lab9;
      lab10:
        z->c = z->l - m5;
  ...
  lab11:
    ...
    if (!(eq_s_b(z, 3, s_30)))
    {
      goto lab14; /* literal, line 140 */
    }
    if (!(find_among_b(z, a_3, 6)))
    {
      goto lab14; /* among, line 140 */
    }
    if (!(eq_s_b(z, 3, s_31)))
    {
      goto lab14; /* literal, line 140 */
    }
    if (!(find_among_b(z, a_4, 6)))
    {
      goto lab14; /* among, line 140 */
    }
    z->bra = z->c; /* ], line 140 */
  ...
  lab15:
    ...
    if (!(eq_s_b(z, 3, s_34)))
    {
      goto lab16; /* literal, line 144 */
    }
    if (!(find_among_b(z, a_5, 6)))
    {
      goto lab16; /* among, line 144 */
    }
    z->bra = z->c; /* ], line 144 */
    {
  ...
  lab16:
    ...
    if (!(eq_s_b(z, 3, s_35)))
    {
      goto lab17; /* literal, line 146 */
    }
    {
      int m7 = z->l - z->c;
      (void)m7; /* or, line 146 */
      if (z->c - 2 <= z->lb || z->p[z->c - 1] >> 5 != 5 || !((4030464 >> (z->p[z->c - 1] & 0x1f)) & 1))
      {
        goto lab19; /* among, line 146 */
      }
      if (!(find_among_b(z, a_6, 6)))
      {
        goto lab19;
      }
      goto lab18;
  ...
  lab17:
    z->c = z->l - m1;
    z->ket = z->c; /* [, line 148 */
    if (!(find_among_b(z, a_8, 3)))
    {
      goto lab20; /* among, line 148 */
    }
    z->bra = z->c; /* ], line 148 */
    {
  ...
  lab20:
    ...
    if (!(eq_s_b(z, 6, s_38)))
    {
      goto lab21; /* literal, line 150 */
    }
    {
      int m_test8 = z->l - z->c; /* test, line 150 */
      {
        int m9 = z->l - z->c;
        (void)m9; /* not, line 150 */
        if (!(find_among_b(z, a_9, 8)))
        {
          goto lab22; /* among, line 150 */
        }
        goto lab21;
      lab22:
        z->c = z->l - m9;
  ...
  lab21:
    ...
    if (!(eq_s_b(z, 6, s_39)))
    {
      goto lab23; /* literal, line 152 */
    }
    {
      int m_test10 = z->l - z->c; /* test, line 152 */
      {
        int m11 = z->l - z->c;
        (void)m11; /* not, line 152 */
        if (!(eq_s_b(z, 3, s_40)))
        {
          goto lab24; /* literal, line 152 */
        }
        goto lab23;
      lab24:
        z->c = z->l - m11;
  ...
  lab25:
    ...
    if (!(eq_s_b(z, 3, s_43)))
    {
      return 0; /* literal, line 156 */
    }
    {
      int m_test12 = z->l - z->c; /* test, line 156 */
      {
        int m13 = z->l - z->c;
        (void)m13; /* or, line 156 */
        if (!(find_among_b(z, a_10, 8)))
        {
          goto lab27; /* among, line 156 */
        }
        goto lab26;
      lab27:
        z->c = z->l - m13;
...
{                /* forwardmode */
  ...
  z->bra = z->c; /* [, line 162 */
  if (z->c + 2 >= z->l || z->p[z->c + 2] >> 5 != 4 || !((672 >> (z->p[z->c + 2] & 0x1f)) & 1))
  {
    return 0; /* among, line 162 */
  }
  if (!(find_among(z, a_11, 3)))
  {
    return 0;
  }
  if (!(find_among(z, a_12, 10)))
  {
    return 0; /* among, line 162 */
  }
  if (!(eq_s(z, 3, s_45)))
  {
    return 0; /* literal, line 162 */
  }
  z->ket = z->c; /* ], line 162 */
  {
...
{              /* forwardmode */
...

  {
    ...
    if (!(eq_s_b(z, 18, s_46)))
    {
      goto lab1; /* literal, line 170 */
    }
    {
      int m_test2 = z->l - z->c; /* test, line 170 */
      {
        int m3 = z->l - z->c;
        (void)m3; /* not, line 170 */
        if (!(find_among_b(z, a_13, 6)))
        {
          goto lab2; /* among, line 170 */
        }
        goto lab1;
      lab2:
        z->c = z->l - m3;
...
{ /* forwardmode */
  ...
  z->lb = z->c;
  z->c = z->l; /* backwards, line 193 */

  z->ket = z->c; /* [, line 194 */
  if (z->c - 5 <= z->lb || z->p[z->c - 1] != 191)
  {
    return 0; /* among, line 194 */
  }
...

  {
    ...
    (void)m1; /* or, line 231 */
    {
      ...
      lab13:
        ...
        if (!(eq_s_b(z, 9, s_67)))
        {
          goto lab14; /* literal, line 226 */
        }
        {
          int m_test4 = z->l - z->c; /* test, line 226 */
          {
            int m5 = z->l - z->c;
            (void)m5; /* not, line 226 */
            if (!(find_among_b(z, a_16, 8)))
            {
              goto lab15; /* among, line 226 */
            }
            goto lab14;
          lab15:
            z->c = z->l - m5;
...
{              /* forwardmode */
  ...
  lab1:
    z->c = z->l - m1;
    {
      ...
      lab5:
      {
        ...
        {
          int m7 = z->l - z->c;
          (void)m7; /* not, line 261 */
          if (!(find_among_b(z, a_18, 6)))
          {
            goto lab7; /* among, line 261 */
          }
          goto lab4;
        lab7:
          z->c = z->l - m7;
      ...
      lab4:
        ...
        if (!(eq_s_b(z, 3, s_74)))
        {
          goto lab2; /* literal, line 262 */
        }
        {
          int m_test8 = z->l - z->c; /* test, line 262 */
          if (!(find_among_b(z, a_19, 6)))
          {
            goto lab2; /* among, line 262 */
          }
          if (!(eq_s_b(z, 3, s_75)))
          {
            goto lab2; /* literal, line 262 */
  ...
  lab2:
    z->c = z->l - m1;
    {
      ...
      {
        int m10 = z->l - z->c;
        (void)m10; /* or, line 267 */
        if (!(eq_s_b(z, 9, s_77)))
        {
          goto lab10; /* literal, line 267 */
        }
        goto lab9;
      lab10:
        z->c = z->l - m10;
      ...
      lab13:
        ...
        if (!(eq_s_b(z, 9, s_81)))
        {
          goto lab14; /* literal, line 271 */
        }
        {
          int m_test11 = z->l - z->c; /* test, line 271 */
          {
            int m12 = z->l - z->c;
            (void)m12; /* not, line 271 */
            if (!(eq_s_b(z, 3, s_82)))
            {
              goto lab15; /* literal, line 271 */
            }
            goto lab14;
          lab15:
            z->c = z->l - m12;
      ...
      lab18:
        ...
        if (!(len_utf8(z->p) >= 7))
        {
          goto lab19; /* $(<integer expression> >= <integer expression>), line 275 */
        }
        if (!(eq_s_b(z, 12, s_86)))
        {
          goto lab19; /* literal, line 275 */
        }
        goto lab9;
      lab19:
        z->c = z->l - m10;
      ...
      lab22:
        ...
        if (!(eq_s_b(z, 6, s_90)))
        {
          goto lab23; /* literal, line 279 */
        }
        {
          int m_test13 = z->l - z->c; /* test, line 279 */
          {
            int m14 = z->l - z->c;
            (void)m14; /* not, line 279 */
            if (!(find_among_b(z, a_20, 8)))
            {
              goto lab24; /* among, line 279 */
            }
            goto lab23;
          lab24:
            z->c = z->l - m14;
  ...
  lab8:
    z->c = z->l - m1;
    {
      ...
      {
        int m16 = z->l - z->c;
        (void)m16; /* or, line 285 */
        if (!(eq_s_b(z, 9, s_93)))
        {
          goto lab27; /* literal, line 285 */
        }
        goto lab26;
      lab27:
        z->c = z->l - m16;
      ...
      lab32:
        ...
        if (!(eq_s_b(z, 6, s_99)))
        {
          goto lab25; /* literal, line 291 */
        }
        {
          int m_test17 = z->l - z->c; /* test, line 291 */
          {
            int m18 = z->l - z->c;
            (void)m18; /* not, line 291 */
            if (!(find_among_b(z, a_21, 8)))
            {
              goto lab33; /* among, line 291 */
            }
            goto lab25;
          lab33:
            z->c = z->l - m18;
...
lab0:
  ...
  {
    int m20 = z->l - z->c;
    (void)m20;     /* do, line 299 */
    z->ket = z->c; /* [, line 299 */
    if (!(eq_s_b(z, 9, s_102)))
    {
      goto lab34; /* literal, line 299 */
    }
    z->bra = z->c; /* ], line 299 */
    {
...
{              /* forwardmode */
  ...
  { /* repeat, line 306 */
    ...
    if (!(z->B[0]))
    {
      goto lab0; /* Boolean test found_a_match, line 306 */
    }
    {
...
{              /* forwardmode */
...

  {
    ...
    (void)m1; /* do, line 313 */
    {
      ...
      (void)m2; /* or, line 320 */
      {
        ...
        z->ket = z->c;             /* [, line 314 */
        if (z->c - 8 <= z->lb || (z->p[z->c - 1] != 129 && z->p[z->c - 1] != 141))
        {
          goto lab2; /* among, line 314 */
        }
    ...
    lab2:
      z->c = z->l - m2;
      {
        ...
        z->ket = z->c;             /* [, line 321 */
        {
          int m5 = z->l - z->c;
          (void)m5; /* or, line 322 */
          if (!(eq_s_b(z, 12, s_104)))
          {
            goto lab5; /* literal, line 322 */
          }
          goto lab4;
        lab5:
          z->c = z->l - m5;
          if (!(eq_s_b(z, 12, s_105)))
          {
            goto lab6; /* literal, line 323 */
          }
          goto lab4;
        lab6:
          z->c = z->l - m5;
          if (!(eq_s_b(z, 9, s_106)))
          {
            goto lab7; /* literal, line 324 */
          }
          goto lab4;
        lab7:
          z->c = z->l - m5;
          if (!(eq_s_b(z, 12, s_107)))
          {
            goto lab8; /* literal, line 325 */
          }
          goto lab4;
        lab8:
          z->c = z->l - m5;
          if (!(eq_s_b(z, 12, s_108)))
          {
            goto lab9; /* literal, line 326 */
          }
          goto lab4;
        lab9:
          z->c = z->l - m5;
          if (!(eq_s_b(z, 12, s_109)))
          {
            goto lab10; /* literal, line 327 */
          }
          goto lab4;
        lab10:
          z->c = z->l - m5;
          if (!(eq_s_b(z, 9, s_110)))
          {
            goto lab11; /* literal, line 328 */
          }
          {
            int m_test6 = z->l - z->c; /* test, line 328 */
            {
              int m7 = z->l - z->c;
              (void)m7; /* not, line 328 */
              if (z->c - 2 <= z->lb || z->p[z->c - 1] >> 5 != 4 || !((1951712 >> (z->p[z->c - 1] & 0x1f)) & 1))
              {
                goto lab12; /* among, line 328 */
              }
              if (!(find_among_b(z, a_23, 12)))
              {
                goto lab12;
              }
              goto lab11;
        ...
        lab24:
          ...
          if (!(eq_s_b(z, 6, s_123)))
          {
            goto lab25; /* literal, line 337 */
          }
          {
            int m_test8 = z->l - z->c; /* test, line 337 */
            {
              int m9 = z->l - z->c;
              (void)m9; /* not, line 337 */
              if (!(find_among_b(z, a_24, 8)))
              {
                goto lab26; /* among, line 337 */
              }
              goto lab25;
            lab26:
              z->c = z->l - m9;
        ...
        lab25:
          z->c = z->l - m5;
          if (!(eq_s_b(z, 15, s_124)))
          {
            goto lab27; /* literal, line 338 */
          }
          goto lab4;
        lab27:
          z->c = z->l - m5;
        ...
        lab28:
          ...
          if (!(eq_s_b(z, 9, s_126)))
          {
            goto lab29; /* literal, line 340 */
          }
          goto lab4;
        lab29:
          z->c = z->l - m5;
          if (!(eq_s_b(z, 12, s_127)))
          {
            goto lab30; /* literal, line 341 */
          }
          goto lab4;
        lab30:
          z->c = z->l - m5;
          if (!(eq_s_b(z, 12, s_128)))
          {
            goto lab31; /* literal, line 342 */
          }
          goto lab4;
        lab31:
          z->c = z->l - m5;
          if (!(eq_s_b(z, 12, s_129)))
          {
            goto lab32; /* literal, line 343 */
          }
          goto lab4;
        lab32:
          z->c = z->l - m5;
          if (!(eq_s_b(z, 12, s_130)))
          {
            goto lab33; /* literal, line 344 */
          }
          goto lab4;
        lab33:
          z->c = z->l - m5;
    ...
    lab3:
      z->c = z->l - m2;
      {
        ...
        {
          int m11 = z->l - z->c;
          (void)m11; /* or, line 352 */
          if (!(eq_s_b(z, 9, s_133)))
          {
            goto lab37; /* literal, line 352 */
          }
          {
            int m_test12 = z->l - z->c; /* test, line 352 */
            {
              int m13 = z->l - z->c;
              (void)m13; /* not, line 352 */
              if (!(eq_s_b(z, 3, s_134)))
              {
                goto lab38; /* literal, line 352 */
              }
              goto lab37;
            lab38:
              z->c = z->l - m13;
        ...
        lab45:
          ...
          if (!(eq_s_b(z, 9, s_142)))
          {
            goto lab46; /* literal, line 360 */
          }
          goto lab36;
        lab46:
          z->c = z->l - m11;
          if (!(eq_s_b(z, 12, s_143)))
          {
            goto lab47; /* literal, line 361 */
          }
          goto lab36;
        lab47:
          z->c = z->l - m11;
          if (!(eq_s_b(z, 12, s_144)))
          {
            goto lab48; /* literal, line 362 */
          }
          goto lab36;
        lab48:
          z->c = z->l - m11;
          if (!(eq_s_b(z, 12, s_145)))
          {
            goto lab49; /* literal, line 363 */
          }
          goto lab36;
        lab49:
          z->c = z->l - m11;
          if (!(eq_s_b(z, 12, s_146)))
          {
            goto lab50; /* literal, line 364 */
          }
          goto lab36;
        lab50:
          z->c = z->l - m11;
          if (!(eq_s_b(z, 9, s_147)))
          {
            goto lab51; /* literal, line 365 */
          }
          goto lab36;
        lab51:
          z->c = z->l - m11;
          if (!(eq_s_b(z, 12, s_148)))
          {
            goto lab52; /* literal, line 366 */
          }
          goto lab36;
        lab52:
          z->c = z->l - m11;
          if (!(eq_s_b(z, 12, s_149)))
          {
            goto lab53; /* literal, line 367 */
          }
          goto lab36;
        lab53:
          z->c = z->l - m11;
          if (!(eq_s_b(z, 9, s_150)))
          {
            goto lab54; /* literal, line 368 */
          }
          goto lab36;
        lab54:
          z->c = z->l - m11;
          if (!(eq_s_b(z, 12, s_151)))
          {
            goto lab35; /* literal, line 369 */
          }
        }
      lab36:
        z->bra = z->c; /* ], line 370 */
    ...
    lab35:
      z->c = z->l - m2;
      {
        ...
        {
          int m15 = z->l - z->c;
          (void)m15; /* or, line 374 */
          if (!(eq_s_b(z, 6, s_153)))
          {
            goto lab56; /* literal, line 374 */
          }
          goto lab55;
        lab56:
          z->c = z->l - m15;
  ...
  {
    int m17 = z->l - z->c;
    (void)m17;     /* do, line 378 */
    z->ket = z->c; /* [, line 378 */
    if (z->c - 8 <= z->lb || (z->p[z->c - 1] != 141 && z->p[z->c - 1] != 177))
    {
      goto lab57; /* among, line 378 */
    }
