...
#endif
  extern int
  dutch_ISO_8859_1_stem(struct SN_env *z);
#ifdef __cplusplus
}
#endif
static int
...
static int
r_en_ending(struct SN_env *z);
static int
r_e_ending(struct SN_env *z);
static int
...
extern "C"
{
  ...
  dutch_ISO_8859_1_create_env(void);
  extern void
  dutch_ISO_8859_1_close_env(struct SN_env *z);
...
{ /* forwardmode */
  int among_var;
  {
    ...
    { /* repeat, line 42 */
      int c2 = z->c;
      z->bra = z->c; /* [, line 43 */
      if (z->c >= z->l || z->p[z->c + 0] >> 5 != 7 || !((340306450 >> (z->p[z->c + 0] & 0x1f)) & 1))
      {
        among_var = 6;
      }
  ...
  { /* repeat, line 58 */
    ...
    { /* goto, line 58 */
      ...
      z->bra = z->c; /* [, line 59 */
      {
        ...
        {
          goto lab5; /* literal, line 59 */
        }
        z->c++;
        z->ket = z->c; /* ], line 59 */
        if (in_grouping(z, g_v, 97, 232, 0))
        {
          goto lab5; /* grouping v, line 59 */
        }
        {
...
{                 /* forwardmode */
  ...
  if (!(z->I[0] < 3))
  {
    goto lab0; /* $(<integer expression> < <integer expression>), line 70 */
  }
