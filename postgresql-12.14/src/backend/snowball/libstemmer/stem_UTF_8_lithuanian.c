...
{ /* backwardmode */
  if (!(z->I[0] <= z->c))
  {
    return 0; /* $(<integer expression> <= <integer expression>), line 43 */
  }
  return 1;
}
  ...
  z->I[0] = z->l; /* $p1 = <integer expression>, line 355 */
  {
    int c1 = z->c; /* do, line 357 */
    {
      ...
      if (!(len_utf8(z->p) > 6))
      {
        z->c = c2;
        goto lab1;
      } /* $(<integer expression> > <integer expression>), line 359 */
      {
