...
#endif
  extern int
  portuguese_UTF_8_stem(struct SN_env *z);
#ifdef __cplusplus
}
#endif
static int
r_residual_form(struct SN_env *z);
static int
...
extern "C"
{
  ...
  portuguese_UTF_8_create_env(void);
  extern void
  portuguese_UTF_8_close_env(struct SN_env *z);
...
{                 /* forwardmode */
  ...
  z->I[2] = z->l; /* $p2 = <integer expression>, line 48 */
  {
    ...
    lab2:
      ...
      if (out_grouping_U(z, g_v, 97, 250, 0))
      {
        goto lab0; /* non v, line 53 */
      }
      {
        int c4 = z->c; /* or, line 53 */
        if (out_grouping_U(z, g_v, 97, 250, 0))
        {
          goto lab6; /* non v, line 53 */
        }
...
{ /* backwardmode */
  if (!(z->I[0] <= z->c))
  {
    return 0; /* $(<integer expression> <= <integer expression>), line 72 */
  }
  return 1;
}
...
{ /* backwardmode */
  if (!(z->I[1] <= z->c))
  {
    return 0; /* $(<integer expression> <= <integer expression>), line 73 */
  }
  return 1;
}
...
{ /* backwardmode */
  if (!(z->I[2] <= z->c))
  {
    return 0; /* $(<integer expression> <= <integer expression>), line 74 */
  }
  return 1;
}
...
{ /* backwardmode */
  int among_var;
  z->ket = z->c; /* [, line 77 */
  if (z->c - 2 <= z->lb || z->p[z->c - 1] >> 5 != 3 || !((823330 >> (z->p[z->c - 1] & 0x1f)) & 1))
  {
...
{                /* backwardmode */
  z->ket = z->c; /* [, line 184 */
  if (!(find_among_b(z, a_7, 7)))
  {
    return 0; /* substring, line 184 */
  }
  z->bra = z->c; /* ], line 184 */
  {
