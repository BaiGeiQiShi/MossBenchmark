...
#endif
extern int
danish_ISO_8859_1_stem(struct SN_env *z);
#ifdef __cplusplus
}
#endif
static int
...
danish_ISO_8859_1_create_env(void);
extern void
danish_ISO_8859_1_close_env(struct SN_env *z);
...
{                 /* forwardmode */
  ...
  /* try, line 35 */
  if (!(z->I[0] < z->I[1])) {
    goto lab0; /* $(<integer expression> < <integer expression>), line 35 */
  }
...
{ /* backwardmode */
  ...
  case 2:
    if (in_grouping_b(z, g_s_ending, 97, 229, 0)) {
      return 0; /* grouping s_ending, line 50 */
    }
    {
