    ...
    while (1) {    /* repeat, line 29 */
      ...
      while (1) { /* goto, line 29 */
        ...
        if (in_grouping(z, g_v, 97, 121, 0)) {
          goto lab4; /* grouping v, line 29 */
        }
        z->bra = z->c; /* [, line 29 */
        if (z->c == z->l || z->p[z->c] != 'y') {
          goto lab4; /* literal, line 29 */
        }
        z->c++;
        z->ket = z->c; /* ], line 29 */
        z->c = c5;
...
{ /* backwardmode */
  {
    ...
    if (out_grouping_b(z, g_v_WXY, 89, 121, 0)) {
      goto lab1; /* non v_WXY, line 50 */
    }
    if (in_grouping_b(z, g_v, 97, 121, 0)) {
      goto lab1; /* grouping v, line 50 */
    }
    if (out_grouping_b(z, g_v, 97, 121, 0)) {
      goto lab1; /* non v, line 50 */
    }
    goto lab0;
  lab1:
    z->c = z->l - m1;
    if (out_grouping_b(z, g_v, 97, 121, 0)) {
      return 0; /* non v, line 52 */
    }
    if (in_grouping_b(z, g_v, 97, 121, 0)) {
      return 0; /* grouping v, line 52 */
    }
    if (z->c > z->lb) {
...
{ /* backwardmode */
  if (!(z->I[0] <= z->c)) {
    return 0; /* $(<integer expression> <= <integer expression>), line 55 */
  }
  return 1;
}
...
{ /* backwardmode */
  if (!(z->I[1] <= z->c)) {
    return 0; /* $(<integer expression> <= <integer expression>), line 56 */
  }
  return 1;
}
...
{ /* backwardmode */
  ...
  case 13:
    if (z->c <= z->lb || z->p[z->c - 1] != 'l') {
      return 0; /* literal, line 119 */
    }
    z->c--;
    {
  ...
  case 15:
    if (in_grouping_b(z, g_valid_LI, 99, 116, 0)) {
      return 0; /* grouping valid_LI, line 122 */
    }
    {
