...
#endif
  extern int
  italian_ISO_8859_1_stem(struct SN_env *z);
#ifdef __cplusplus
}
#endif
static int
...
static int
r_attached_pronoun(struct SN_env *z);
static int
...
extern "C"
{
  ...
  italian_ISO_8859_1_create_env(void);
  extern void
  italian_ISO_8859_1_close_env(struct SN_env *z);
  ...
  { /* repeat, line 46 */
    ...
    { /* goto, line 46 */
      ...
      z->bra = z->c; /* [, line 47 */
      {
        ...
        {
          goto lab4; /* literal, line 47 */
        }
        z->c++;
        z->ket = z->c; /* ], line 47 */
        if (in_grouping(z, g_v, 97, 249, 0))
        {
          goto lab4; /* grouping v, line 47 */
        }
        {
      ...
      lab4:
        ...
        {
          goto lab2; /* literal, line 48 */
        }
        z->c++;
        z->ket = z->c; /* ], line 48 */
        if (in_grouping(z, g_v, 97, 249, 0))
        {
          goto lab2; /* grouping v, line 48 */
        }
        {
...
{                 /* forwardmode */
  ...
  z->I[2] = z->l; /* $p2 = <integer expression>, line 56 */
  {
    int c1 = z->c; /* do, line 58 */
    {
      ...
      if (in_grouping(z, g_v, 97, 249, 0))
      {
        goto lab2; /* grouping v, line 59 */
      }
      {
        int c3 = z->c; /* or, line 59 */
        if (out_grouping(z, g_v, 97, 249, 0))
        {
          goto lab4; /* non v, line 59 */
        }
    ...
    lab2:
      ...
      if (out_grouping(z, g_v, 97, 249, 0))
      {
        goto lab0; /* non v, line 61 */
      }
      {
        int c4 = z->c; /* or, line 61 */
        if (out_grouping(z, g_v, 97, 249, 0))
        {
          goto lab6; /* non v, line 61 */
        }
...
{ /* backwardmode */
  if (!(z->I[0] <= z->c))
  {
    return 0; /* $(<integer expression> <= <integer expression>), line 82 */
  }
  return 1;
}
...
{ /* backwardmode */
  if (!(z->I[1] <= z->c))
  {
    return 0; /* $(<integer expression> <= <integer expression>), line 83 */
  }
  return 1;
}
...
{ /* backwardmode */
  if (!(z->I[2] <= z->c))
  {
    return 0; /* $(<integer expression> <= <integer expression>), line 84 */
  }
  return 1;
}
...
{ /* backwardmode */
  {
    int m1 = z->l - z->c;
    (void)m1;      /* try, line 171 */
    z->ket = z->c; /* [, line 172 */
    if (in_grouping_b(z, g_AEIO, 97, 242, 0))
    {
      z->c = z->l - m1;
      goto lab0;
    }              /* grouping AEIO, line 172 */
    z->bra = z->c; /* ], line 172 */
    {
