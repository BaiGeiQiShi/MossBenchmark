...
#endif
  extern int
  german_ISO_8859_1_stem(struct SN_env *z);
#ifdef __cplusplus
}
#endif
static int
...
extern "C"
{
  ...
  german_ISO_8859_1_create_env(void);
  extern void
  german_ISO_8859_1_close_env(struct SN_env *z);
