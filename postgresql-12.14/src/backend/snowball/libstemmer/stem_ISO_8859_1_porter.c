...
#endif
  extern int
  porter_ISO_8859_1_stem(struct SN_env *z);
#ifdef __cplusplus
}
#endif
static int
...
extern "C"
{
  ...
  porter_ISO_8859_1_create_env(void);
  extern void
  porter_ISO_8859_1_close_env(struct SN_env *z);
...
{ /* backwardmode */
  ...
  {
    return 0; /* non v_WXY, line 19 */
  }
  if (in_grouping_b(z, g_v, 97, 121, 0))
  {
    return 0; /* grouping v, line 19 */
  }
  if (out_grouping_b(z, g_v, 97, 121, 0))
  {
    return 0; /* non v, line 19 */
  }
  return 1;
}
...
{ /* backwardmode */
  if (!(z->I[0] <= z->c))
  {
    return 0; /* $(<integer expression> <= <integer expression>), line 21 */
  }
  return 1;
}
...
{ /* backwardmode */
  if (!(z->I[1] <= z->c))
  {
    return 0; /* $(<integer expression> <= <integer expression>), line 22 */
  }
  return 1;
}
  ...
  }
  {
    ...
    { /* repeat, line 117 */
      ...
      { /* goto, line 117 */
        ...
        {
          goto lab3; /* grouping v, line 117 */
        }
        z->bra = z->c; /* [, line 117 */
        if (z->c == z->l || z->p[z->c] != 'y')
        {
          goto lab3; /* literal, line 117 */
        }
        z->c++;
        z->ket = z->c; /* ], line 117 */
        z->c = c4;
