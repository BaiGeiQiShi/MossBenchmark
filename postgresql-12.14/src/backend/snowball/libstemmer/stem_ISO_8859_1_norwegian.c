...
#endif
extern int
norwegian_ISO_8859_1_stem(struct SN_env *z);
#ifdef __cplusplus
}
#endif
static int
...
norwegian_ISO_8859_1_create_env(void);
extern void
norwegian_ISO_8859_1_close_env(struct SN_env *z);
...
{                 /* forwardmode */
  ...
  /* try, line 32 */
  if (!(z->I[0] < z->I[1])) {
    goto lab0; /* $(<integer expression> < <integer expression>), line 32 */
  }
...
{ /* backwardmode */
  ...
  case 2: {
    ...
    if (in_grouping_b(z, g_s_ending, 98, 122, 0)) {
      goto lab1; /* grouping s_ending, line 46 */
    }
    goto lab0;
  lab1:
    z->c = z->l - m2;
    if (z->c <= z->lb || z->p[z->c - 1] != 'k') {
      return 0; /* literal, line 46 */
    }
    z->c--;
    if (out_grouping_b(z, g_v, 97, 248, 0)) {
      return 0; /* non v, line 46 */
    }
  }
  lab0: {
