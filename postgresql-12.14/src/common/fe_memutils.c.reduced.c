...
void *pg_malloc(size_t size) { return pg_malloc_internal(size, 0); }
 ...
 */
void *palloc(Size size) { return pg_malloc_internal(size, 0); }

void *palloc0(Size size) { return pg_malloc_internal(size, MCXT_ALLOC_ZERO); }
