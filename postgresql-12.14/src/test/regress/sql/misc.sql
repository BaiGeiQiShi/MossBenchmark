...
COPY onek2 FROM '/postgresql-12.14/src/test/regress/results/onek.data';

SELECT unique1 FROM onek2 WHERE unique1 < 2 ORDER BY unique1;

COPY BINARY stud_emp TO '/postgresql-12.14/src/test/regress/results/stud_emp.data';

DELETE FROM stud_emp;

COPY BINARY stud_emp FROM '/postgresql-12.14/src/test/regress/results/stud_emp.data';
