...
BEGIN
  ...
  PERFORM lo_export(loid, '/postgresql-12.14/src/test/regress/results/invalid/path');
EXCEPTION
...
INSERT INTO lotest_stash_values (loid) SELECT lo_import('/postgresql-12.14/src/test/regress/data/tenk.data');
...
SELECT lo_export(loid, '/postgresql-12.14/src/test/regress/results/lotest.txt') FROM lotest_stash_values;

\lo_import '/postgresql-12.14/src/test/regress/results/lotest.txt'

\set newloid :LASTOID

-- just make sure \lo_export does not barf
\lo_export :newloid '/postgresql-12.14/src/test/regress/results/lotest2.txt'
