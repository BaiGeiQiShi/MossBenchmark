...
CREATE TABLESPACE regress_tblspacewith LOCATION '/postgresql-12.14/src/test/regress/testtablespace' WITH (some_nonexistent_parameter = true); -- fail
CREATE TABLESPACE regress_tblspacewith LOCATION '/postgresql-12.14/src/test/regress/testtablespace' WITH (random_page_cost = 3.0); -- ok
...
CREATE TABLESPACE regress_tblspace LOCATION '/postgresql-12.14/src/test/regress/testtablespace';
