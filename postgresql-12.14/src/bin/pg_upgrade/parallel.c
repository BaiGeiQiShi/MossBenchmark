 ...
 *	parallel_exec_prog
 *
 *	This has the same API as exec_prog, except it does parallel execution,*	and therefore must throw errors and doesn't return an error status.
 */
void
 ...
 *execution by transferring multiple tablespaces in parallel
 */
void
