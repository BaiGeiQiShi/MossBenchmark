...
{
  appendPQExpBuffer(buf,"ALTER MATERIALIZED VIEW [ IF EXISTS ] %s\n    %s [, ... ]\nALTER MATERIALIZED VIEW %s\n    DEPENDS ON EXTENSION %s\nALTER MATERIALIZED VIEW [ IF EXISTS ] %s\n    RENAME [ COLUMN ] %s TO %s\nALTER MATERIALIZED VIEW [ IF EXISTS ] %s\n    RENAME TO %s\nALTER MATERIALIZED VIEW [ IF EXISTS ] %s\n    SET SCHEMA %s\nALTER MATERIALIZED VIEW ALL IN TABLESPACE %s [ OWNED BY %s [, ... ] ]\n    SET TABLESPACE %s [ NOWAIT ]\n\n%s\n\n    ALTER [ COLUMN ] %s SET STATISTICS %s\n    ALTER [ COLUMN ] %s SET ( %s = %s [, ... ] )\n    ALTER [ COLUMN ] %s RESET ( %s [, ... ] )\n    ALTER [ COLUMN ] %s SET STORAGE { PLAIN | EXTERNAL | EXTENDED | MAIN }\n    CLUSTER ON %s\n    SET WITHOUT CLUSTER\n    SET TABLESPACE %s\n    SET ( %s [= %s] [, ... ] )\n    RESET ( %s [, ... ] )\n    OWNER TO { %s | CURRENT_USER | SESSION_USER }",_("name"), _("action"), _("name"), _("extension_name"), _("name"), _("column_name"), _("new_column_name"), _("name"), _("new_name"), _("name"), _("new_schema"), _("name"), _("role_name"), _("new_tablespace"), _("where action is one of:"), _("column_name"), _("integer"), _("column_name"), _("attribute_option"), _("value"), _("column_name"), _("attribute_option"), _("column_name"), _("index_name"), _("new_tablespace"), _("storage_parameter"), _("value"), _("storage_parameter"), _("new_owner"));
}

static void
sql_help_ALTER_OPERATOR(PQExpBuffer buf)
{
  appendPQExpBuffer(buf,"ALTER OPERATOR %s ( { %s | NONE } , { %s | NONE } )\n    OWNER TO { %s | CURRENT_USER | SESSION_USER }\n\nALTER OPERATOR %s ( { %s | NONE } , { %s | NONE } )\n    SET SCHEMA %s\n\nALTER OPERATOR %s ( { %s | NONE } , { %s | NONE } )\n    SET ( {  RESTRICT = { %s | NONE }\n           | JOIN = { %s | NONE }\n         } [, ... ] )",_("name"), _("left_type"), _("right_type"), _("new_owner"), _("name"), _("left_type"), _("right_type"), _("new_schema"), _("name"), _("left_type"), _("right_type"), _("res_proc"), _("join_proc"));
}

static void
sql_help_ALTER_OPERATOR_CLASS(PQExpBuffer buf)
{
  appendPQExpBuffer(buf,"ALTER OPERATOR CLASS %s USING %s\n    RENAME TO %s\n\nALTER OPERATOR CLASS %s USING %s\n    OWNER TO { %s | CURRENT_USER | SESSION_USER }\n\nALTER OPERATOR CLASS %s USING %s\n    SET SCHEMA %s",_("name"), _("index_method"), _("new_name"), _("name"), _("index_method"), _("new_owner"), _("name"), _("index_method"), _("new_schema"));
}

static void
sql_help_ALTER_OPERATOR_FAMILY(PQExpBuffer buf)
{
  appendPQExpBuffer(buf,"ALTER OPERATOR FAMILY %s USING %s ADD\n  {  OPERATOR %s %s ( %s, %s )\n              [ FOR SEARCH | FOR ORDER BY %s ]\n   | FUNCTION %s [ ( %s [ , %s ] ) ]\n              %s [ ( %s [, ...] ) ]\n  } [, ... ]\n\nALTER OPERATOR FAMILY %s USING %s DROP\n  {  OPERATOR %s ( %s [ , %s ] )\n   | FUNCTION %s ( %s [ , %s ] )\n  } [, ... ]\n\nALTER OPERATOR FAMILY %s USING %s\n    RENAME TO %s\n\nALTER OPERATOR FAMILY %s USING %s\n    OWNER TO { %s | CURRENT_USER | SESSION_USER }\n\nALTER OPERATOR FAMILY %s USING %s\n    SET SCHEMA %s",_("name"), _("index_method"), _("strategy_number"), _("operator_name"), _("op_type"), _("op_type"), _("sort_family_name"), _("support_number"), _("op_type"), _("op_type"), _("function_name"), _("argument_type"), _("name"), _("index_method"), _("strategy_number"), _("op_type"), _("op_type"), _("support_number"), _("op_type"), _("op_type"), _("name"), _("index_method"), _("new_name"), _("name"), _("index_method"), _("new_owner"), _("name"), _("index_method"), _("new_schema"));
}

static void
sql_help_ALTER_POLICY(PQExpBuffer buf)
{
  appendPQExpBuffer(buf,"ALTER POLICY %s ON %s RENAME TO %s\n\nALTER POLICY %s ON %s\n    [ TO { %s | PUBLIC | CURRENT_USER | SESSION_USER } [, ...] ]\n    [ USING ( %s ) ]\n    [ WITH CHECK ( %s ) ]",_("name"), _("table_name"), _("new_name"), _("name"), _("table_name"), _("role_name"), _("using_expression"), _("check_expression"));
}

static void
sql_help_ALTER_PROCEDURE(PQExpBuffer buf)
{
  appendPQExpBuffer(buf,"ALTER PROCEDURE %s [ ( [ [ %s ] [ %s ] %s [, ...] ] ) ]\n    %s [ ... ] [ RESTRICT ]\nALTER PROCEDURE %s [ ( [ [ %s ] [ %s ] %s [, ...] ] ) ]\n    RENAME TO %s\nALTER PROCEDURE %s [ ( [ [ %s ] [ %s ] %s [, ...] ] ) ]\n    OWNER TO { %s | CURRENT_USER | SESSION_USER }\nALTER PROCEDURE %s [ ( [ [ %s ] [ %s ] %s [, ...] ] ) ]\n    SET SCHEMA %s\nALTER PROCEDURE %s [ ( [ [ %s ] [ %s ] %s [, ...] ] ) ]\n    DEPENDS ON EXTENSION %s\n\n%s\n\n    [ EXTERNAL ] SECURITY INVOKER | [ EXTERNAL ] SECURITY DEFINER\n    SET %s { TO | = } { %s | DEFAULT }\n    SET %s FROM CURRENT\n    RESET %s\n    RESET ALL",_("name"), _("argmode"), _("argname"), _("argtype"), _("action"), _("name"), _("argmode"), _("argname"), _("argtype"), _("new_name"), _("name"), _("argmode"), _("argname"), _("argtype"), _("new_owner"), _("name"), _("argmode"), _("argname"), _("argtype"), _("new_schema"), _("name"), _("argmode"), _("argname"), _("argtype"), _("extension_name"), _("where action is one of:"), _("configuration_parameter"), _("value"), _("configuration_parameter"), _("configuration_parameter"));
}

static void
sql_help_ALTER_PUBLICATION(PQExpBuffer buf)
{
  appendPQExpBuffer(buf,"ALTER PUBLICATION %s ADD TABLE [ ONLY ] %s [ * ] [, ...]\nALTER PUBLICATION %s SET TABLE [ ONLY ] %s [ * ] [, ...]\nALTER PUBLICATION %s DROP TABLE [ ONLY ] %s [ * ] [, ...]\nALTER PUBLICATION %s SET ( %s [= %s] [, ... ] )\nALTER PUBLICATION %s OWNER TO { %s | CURRENT_USER | SESSION_USER }\nALTER PUBLICATION %s RENAME TO %s",_("name"), _("table_name"), _("name"), _("table_name"), _("name"), _("table_name"), _("name"), _("publication_parameter"), _("value"), _("name"), _("new_owner"), _("name"), _("new_name"));
}

static void
sql_help_ALTER_ROLE(PQExpBuffer buf)
{
  appendPQExpBuffer(buf,"ALTER ROLE %s [ WITH ] %s [ ... ]\n\n%s\n\n      SUPERUSER | NOSUPERUSER\n    | CREATEDB | NOCREATEDB\n    | CREATEROLE | NOCREATEROLE\n    | INHERIT | NOINHERIT\n    | LOGIN | NOLOGIN\n    | REPLICATION | NOREPLICATION\n    | BYPASSRLS | NOBYPASSRLS\n    | CONNECTION LIMIT %s\n    | [ ENCRYPTED ] PASSWORD '%s' | PASSWORD NULL\n    | VALID UNTIL '%s'\n\nALTER ROLE %s RENAME TO %s\n\nALTER ROLE { %s | ALL } [ IN DATABASE %s ] SET %s { TO | = } { %s | DEFAULT }\nALTER ROLE { %s | ALL } [ IN DATABASE %s ] SET %s FROM CURRENT\nALTER ROLE { %s | ALL } [ IN DATABASE %s ] RESET %s\nALTER ROLE { %s | ALL } [ IN DATABASE %s ] RESET ALL\n\n%s\n\n    %s\n  | CURRENT_USER\n  | SESSION_USER",_("role_specification"), _("option"), _("where option can be:"), _("connlimit"), _("password"), _("timestamp"), _("name"), _("new_name"), _("role_specification"), _("database_name"), _("configuration_parameter"), _("value"), _("role_specification"), _("database_name"), _("configuration_parameter"), _("role_specification"), _("database_name"), _("configuration_parameter"), _("role_specification"), _("database_name"), _("where role_specification can be:"), _("role_name"));
}

static void
sql_help_ALTER_ROUTINE(PQExpBuffer buf)
{
  appendPQExpBuffer(buf,"ALTER ROUTINE %s [ ( [ [ %s ] [ %s ] %s [, ...] ] ) ]\n    %s [ ... ] [ RESTRICT ]\nALTER ROUTINE %s [ ( [ [ %s ] [ %s ] %s [, ...] ] ) ]\n    RENAME TO %s\nALTER ROUTINE %s [ ( [ [ %s ] [ %s ] %s [, ...] ] ) ]\n    OWNER TO { %s | CURRENT_USER | SESSION_USER }\nALTER ROUTINE %s [ ( [ [ %s ] [ %s ] %s [, ...] ] ) ]\n    SET SCHEMA %s\nALTER ROUTINE %s [ ( [ [ %s ] [ %s ] %s [, ...] ] ) ]\n    DEPENDS ON EXTENSION %s\n\n%s\n\n    IMMUTABLE | STABLE | VOLATILE\n    [ NOT ] LEAKPROOF\n    [ EXTERNAL ] SECURITY INVOKER | [ EXTERNAL ] SECURITY DEFINER\n    PARALLEL { UNSAFE | RESTRICTED | SAFE }\n    COST %s\n    ROWS %s\n    SET %s { TO | = } { %s | DEFAULT }\n    SET %s FROM CURRENT\n    RESET %s\n    RESET ALL",_("name"), _("argmode"), _("argname"), _("argtype"), _("action"), _("name"), _("argmode"), _("argname"), _("argtype"), _("new_name"), _("name"), _("argmode"), _("argname"), _("argtype"), _("new_owner"), _("name"), _("argmode"), _("argname"), _("argtype"), _("new_schema"), _("name"), _("argmode"), _("argname"), _("argtype"), _("extension_name"), _("where action is one of:"), _("execution_cost"), _("result_rows"), _("configuration_parameter"), _("value"), _("configuration_parameter"), _("configuration_parameter"));
}
...
{
  appendPQExpBuffer(buf,"DECLARE %s [ BINARY ] [ INSENSITIVE ] [ [ NO ] SCROLL ]\n    CURSOR [ { WITH | WITHOUT } HOLD ] FOR %s",_("name"), _("query"));
}

static void
sql_help_DELETE(PQExpBuffer buf)
{
  appendPQExpBuffer(buf,"[ WITH [ RECURSIVE ] %s [, ...] ]\nDELETE FROM [ ONLY ] %s [ * ] [ [ AS ] %s ]\n    [ USING %s [, ...] ]\n    [ WHERE %s | WHERE CURRENT OF %s ]\n    [ RETURNING * | %s [ [ AS ] %s ] [, ...] ]",_("with_query"), _("table_name"), _("alias"), _("from_item"), _("condition"), _("cursor_name"), _("output_expression"), _("output_name"));
}
...
{
  appendPQExpBuffer(buf,"DROP AGGREGATE [ IF EXISTS ] %s ( %s ) [, ...] [ CASCADE | RESTRICT ]\n\n%s\n\n* |\n[ %s ] [ %s ] %s [ , ... ] |\n[ [ %s ] [ %s ] %s [ , ... ] ] ORDER BY [ %s ] [ %s ] %s [ , ... ]",_("name"), _("aggregate_signature"), _("where aggregate_signature is:"), _("argmode"), _("argname"), _("argtype"), _("argmode"), _("argname"), _("argtype"), _("argmode"), _("argname"), _("argtype"));
}
...
{
  appendPQExpBuffer(buf,"DROP FUNCTION [ IF EXISTS ] %s [ ( [ [ %s ] [ %s ] %s [, ...] ] ) ] [, ...]\n    [ CASCADE | RESTRICT ]",_("name"), _("argmode"), _("argname"), _("argtype"));
}
...
{
  appendPQExpBuffer(buf,"DROP PROCEDURE [ IF EXISTS ] %s [ ( [ [ %s ] [ %s ] %s [, ...] ] ) ] [, ...]\n    [ CASCADE | RESTRICT ]",_("name"), _("argmode"), _("argname"), _("argtype"));
}
...
{
  appendPQExpBuffer(buf,"DROP ROUTINE [ IF EXISTS ] %s [ ( [ [ %s ] [ %s ] %s [, ...] ] ) ] [, ...]\n    [ CASCADE | RESTRICT ]",_("name"), _("argmode"), _("argname"), _("argtype"));
}
...
{
  appendPQExpBuffer(buf,"EXPLAIN [ ( %s [, ...] ) ] %s\nEXPLAIN [ ANALYZE ] [ VERBOSE ] %s\n\n%s\n\n    ANALYZE [ %s ]\n    VERBOSE [ %s ]\n    COSTS [ %s ]\n    SETTINGS [ %s ]\n    BUFFERS [ %s ]\n    TIMING [ %s ]\n    SUMMARY [ %s ]\n    FORMAT { TEXT | XML | JSON | YAML }",_("option"), _("statement"), _("statement"), _("where option can be one of:"), _("boolean"), _("boolean"), _("boolean"), _("boolean"), _("boolean"), _("boolean"), _("boolean"));
}

static void
sql_help_FETCH(PQExpBuffer buf)
{
  appendPQExpBuffer(buf,"FETCH [ %s ] [ FROM | IN ] %s\n\n%s\n\n    NEXT\n    PRIOR\n    FIRST\n    LAST\n    ABSOLUTE %s\n    RELATIVE %s\n    %s\n    ALL\n    FORWARD\n    FORWARD %s\n    FORWARD ALL\n    BACKWARD\n    BACKWARD %s\n    BACKWARD ALL",_("direction"), _("cursor_name"), _("where direction can be one of:"), _("count"), _("count"), _("count"), _("count"), _("count"));
}

static void
sql_help_GRANT(PQExpBuffer buf)
{
  appendPQExpBuffer(buf,"GRANT { { SELECT | INSERT | UPDATE | DELETE | TRUNCATE | REFERENCES | TRIGGER }\n    [, ...] | ALL [ PRIVILEGES ] }\n    ON { [ TABLE ] %s [, ...]\n         | ALL TABLES IN SCHEMA %s [, ...] }\n    TO %s [, ...] [ WITH GRANT OPTION ]\n\nGRANT { { SELECT | INSERT | UPDATE | REFERENCES } ( %s [, ...] )\n    [, ...] | ALL [ PRIVILEGES ] ( %s [, ...] ) }\n    ON [ TABLE ] %s [, ...]\n    TO %s [, ...] [ WITH GRANT OPTION ]\n\nGRANT { { USAGE | SELECT | UPDATE }\n    [, ...] | ALL [ PRIVILEGES ] }\n    ON { SEQUENCE %s [, ...]\n         | ALL SEQUENCES IN SCHEMA %s [, ...] }\n    TO %s [, ...] [ WITH GRANT OPTION ]\n\nGRANT { { CREATE | CONNECT | TEMPORARY | TEMP } [, ...] | ALL [ PRIVILEGES ] }\n    ON DATABASE %s [, ...]\n    TO %s [, ...] [ WITH GRANT OPTION ]\n\nGRANT { USAGE | ALL [ PRIVILEGES ] }\n    ON DOMAIN %s [, ...]\n    TO %s [, ...] [ WITH GRANT OPTION ]\n\nGRANT { USAGE | ALL [ PRIVILEGES ] }\n    ON FOREIGN DATA WRAPPER %s [, ...]\n    TO %s [, ...] [ WITH GRANT OPTION ]\n\nGRANT { USAGE | ALL [ PRIVILEGES ] }\n    ON FOREIGN SERVER %s [, ...]\n    TO %s [, ...] [ WITH GRANT OPTION ]\n\nGRANT { EXECUTE | ALL [ PRIVILEGES ] }\n    ON { { FUNCTION | PROCEDURE | ROUTINE } %s [ ( [ [ %s ] [ %s ] %s [, ...] ] ) ] [, ...]\n         | ALL { FUNCTIONS | PROCEDURES | ROUTINES } IN SCHEMA %s [, ...] }\n    TO %s [, ...] [ WITH GRANT OPTION ]\n\nGRANT { USAGE | ALL [ PRIVILEGES ] }\n    ON LANGUAGE %s [, ...]\n    TO %s [, ...] [ WITH GRANT OPTION ]\n\nGRANT { { SELECT | UPDATE } [, ...] | ALL [ PRIVILEGES ] }\n    ON LARGE OBJECT %s [, ...]\n    TO %s [, ...] [ WITH GRANT OPTION ]\n\nGRANT { { CREATE | USAGE } [, ...] | ALL [ PRIVILEGES ] }\n    ON SCHEMA %s [, ...]\n    TO %s [, ...] [ WITH GRANT OPTION ]\n\nGRANT { CREATE | ALL [ PRIVILEGES ] }\n    ON TABLESPACE %s [, ...]\n    TO %s [, ...] [ WITH GRANT OPTION ]\n\nGRANT { USAGE | ALL [ PRIVILEGES ] }\n    ON TYPE %s [, ...]\n    TO %s [, ...] [ WITH GRANT OPTION ]\n\nGRANT %s [, ...] TO %s [, ...]\n    [ WITH ADMIN OPTION ]\n    [ GRANTED BY %s ]\n\n%s\n\n    [ GROUP ] %s\n  | PUBLIC\n  | CURRENT_USER\n  | SESSION_USER",_("table_name"), _("schema_name"), _("role_specification"), _("column_name"), _("column_name"), _("table_name"), _("role_specification"), _("sequence_name"), _("schema_name"), _("role_specification"), _("database_name"), _("role_specification"), _("domain_name"), _("role_specification"), _("fdw_name"), _("role_specification"), _("server_name"), _("role_specification"), _("routine_name"), _("argmode"), _("arg_name"), _("arg_type"), _("schema_name"), _("role_specification"), _("lang_name"), _("role_specification"), _("loid"), _("role_specification"), _("schema_name"), _("role_specification"), _("tablespace_name"), _("role_specification"), _("type_name"), _("role_specification"), _("role_name"), _("role_specification"), _("role_specification"), _("where role_specification can be:"), _("role_name"));
}

static void
sql_help_IMPORT_FOREIGN_SCHEMA(PQExpBuffer buf)
{
  appendPQExpBuffer(buf,"IMPORT FOREIGN SCHEMA %s\n    [ { LIMIT TO | EXCEPT } ( %s [, ...] ) ]\n    FROM SERVER %s\n    INTO %s\n    [ OPTIONS ( %s '%s' [, ... ] ) ]",_("remote_schema"), _("table_name"), _("server_name"), _("local_schema"), _("option"), _("value"));
}
...
{
  appendPQExpBuffer(buf,"LOCK [ TABLE ] [ ONLY ] %s [ * ] [, ...] [ IN %s MODE ] [ NOWAIT ]\n\n%s\n\n    ACCESS SHARE | ROW SHARE | ROW EXCLUSIVE | SHARE UPDATE EXCLUSIVE\n    | SHARE | SHARE ROW EXCLUSIVE | EXCLUSIVE | ACCESS EXCLUSIVE",_("name"), _("lockmode"), _("where lockmode is one of:"));
}

static void
sql_help_MOVE(PQExpBuffer buf)
{
  appendPQExpBuffer(buf,"MOVE [ %s ] [ FROM | IN ] %s\n\n%s\n\n    NEXT\n    PRIOR\n    FIRST\n    LAST\n    ABSOLUTE %s\n    RELATIVE %s\n    %s\n    ALL\n    FORWARD\n    FORWARD %s\n    FORWARD ALL\n    BACKWARD\n    BACKWARD %s\n    BACKWARD ALL",_("direction"), _("cursor_name"), _("where direction can be one of:"), _("count"), _("count"), _("count"), _("count"), _("count"));
}
...
{
  appendPQExpBuffer(buf,"REASSIGN OWNED BY { %s | CURRENT_USER | SESSION_USER } [, ...]\n               TO { %s | CURRENT_USER | SESSION_USER }",_("old_role"), _("new_role"));
}

static void
sql_help_REFRESH_MATERIALIZED_VIEW(PQExpBuffer buf)
{
  appendPQExpBuffer(buf,"REFRESH MATERIALIZED VIEW [ CONCURRENTLY ] %s\n    [ WITH [ NO ] DATA ]",_("name"));
}
...
{
  appendPQExpBuffer(buf,"RESET %s\nRESET ALL",_("configuration_parameter"));
}

static void
sql_help_REVOKE(PQExpBuffer buf)
{
  appendPQExpBuffer(buf,"REVOKE [ GRANT OPTION FOR ]\n    { { SELECT | INSERT | UPDATE | DELETE | TRUNCATE | REFERENCES | TRIGGER }\n    [, ...] | ALL [ PRIVILEGES ] }\n    ON { [ TABLE ] %s [, ...]\n         | ALL TABLES IN SCHEMA %s [, ...] }\n    FROM %s [, ...]\n    [ CASCADE | RESTRICT ]\n\nREVOKE [ GRANT OPTION FOR ]\n    { { SELECT | INSERT | UPDATE | REFERENCES } ( %s [, ...] )\n    [, ...] | ALL [ PRIVILEGES ] ( %s [, ...] ) }\n    ON [ TABLE ] %s [, ...]\n    FROM %s [, ...]\n    [ CASCADE | RESTRICT ]\n\nREVOKE [ GRANT OPTION FOR ]\n    { { USAGE | SELECT | UPDATE }\n    [, ...] | ALL [ PRIVILEGES ] }\n    ON { SEQUENCE %s [, ...]\n         | ALL SEQUENCES IN SCHEMA %s [, ...] }\n    FROM %s [, ...]\n    [ CASCADE | RESTRICT ]\n\nREVOKE [ GRANT OPTION FOR ]\n    { { CREATE | CONNECT | TEMPORARY | TEMP } [, ...] | ALL [ PRIVILEGES ] }\n    ON DATABASE %s [, ...]\n    FROM %s [, ...]\n    [ CASCADE | RESTRICT ]\n\nREVOKE [ GRANT OPTION FOR ]\n    { USAGE | ALL [ PRIVILEGES ] }\n    ON DOMAIN %s [, ...]\n    FROM %s [, ...]\n    [ CASCADE | RESTRICT ]\n\nREVOKE [ GRANT OPTION FOR ]\n    { USAGE | ALL [ PRIVILEGES ] }\n    ON FOREIGN DATA WRAPPER %s [, ...]\n    FROM %s [, ...]\n    [ CASCADE | RESTRICT ]\n\nREVOKE [ GRANT OPTION FOR ]\n    { USAGE | ALL [ PRIVILEGES ] }\n    ON FOREIGN SERVER %s [, ...]\n    FROM %s [, ...]\n    [ CASCADE | RESTRICT ]\n\nREVOKE [ GRANT OPTION FOR ]\n    { EXECUTE | ALL [ PRIVILEGES ] }\n    ON { { FUNCTION | PROCEDURE | ROUTINE } %s [ ( [ [ %s ] [ %s ] %s [, ...] ] ) ] [, ...]\n         | ALL { FUNCTIONS | PROCEDURES | ROUTINES } IN SCHEMA %s [, ...] }\n    FROM %s [, ...]\n    [ CASCADE | RESTRICT ]\n\nREVOKE [ GRANT OPTION FOR ]\n    { USAGE | ALL [ PRIVILEGES ] }\n    ON LANGUAGE %s [, ...]\n    FROM %s [, ...]\n    [ CASCADE | RESTRICT ]\n\nREVOKE [ GRANT OPTION FOR ]\n    { { SELECT | UPDATE } [, ...] | ALL [ PRIVILEGES ] }\n    ON LARGE OBJECT %s [, ...]\n    FROM %s [, ...]\n    [ CASCADE | RESTRICT ]\n\nREVOKE [ GRANT OPTION FOR ]\n    { { CREATE | USAGE } [, ...] | ALL [ PRIVILEGES ] }\n    ON SCHEMA %s [, ...]\n    FROM %s [, ...]\n    [ CASCADE | RESTRICT ]\n\nREVOKE [ GRANT OPTION FOR ]\n    { CREATE | ALL [ PRIVILEGES ] }\n    ON TABLESPACE %s [, ...]\n    FROM %s [, ...]\n    [ CASCADE | RESTRICT ]\n\nREVOKE [ GRANT OPTION FOR ]\n    { USAGE | ALL [ PRIVILEGES ] }\n    ON TYPE %s [, ...]\n    FROM %s [, ...]\n    [ CASCADE | RESTRICT ]\n\nREVOKE [ ADMIN OPTION FOR ]\n    %s [, ...] FROM %s [, ...]\n    [ GRANTED BY %s ]\n    [ CASCADE | RESTRICT ]\n\n%s\n\n    [ GROUP ] %s\n  | PUBLIC\n  | CURRENT_USER\n  | SESSION_USER",_("table_name"), _("schema_name"), _("role_specification"), _("column_name"), _("column_name"), _("table_name"), _("role_specification"), _("sequence_name"), _("schema_name"), _("role_specification"), _("database_name"), _("role_specification"), _("domain_name"), _("role_specification"), _("fdw_name"), _("role_specification"), _("server_name"), _("role_specification"), _("function_name"), _("argmode"), _("arg_name"), _("arg_type"), _("schema_name"), _("role_specification"), _("lang_name"), _("role_specification"), _("loid"), _("role_specification"), _("schema_name"), _("role_specification"), _("tablespace_name"), _("role_specification"), _("type_name"), _("role_specification"), _("role_name"), _("role_specification"), _("role_specification"), _("where role_specification can be:"), _("role_name"));
}
...
{
  appendPQExpBuffer(buf,"SET [ SESSION | LOCAL ] ROLE %s\nSET [ SESSION | LOCAL ] ROLE NONE\nRESET ROLE",_("role_name"));
}

static void
sql_help_SET_SESSION_AUTHORIZATION(PQExpBuffer buf)
{
  appendPQExpBuffer(buf,"SET [ SESSION | LOCAL ] SESSION AUTHORIZATION %s\nSET [ SESSION | LOCAL ] SESSION AUTHORIZATION DEFAULT\nRESET SESSION AUTHORIZATION",_("user_name"));
}

static void
sql_help_SET_TRANSACTION(PQExpBuffer buf)
{
  appendPQExpBuffer(buf,"SET TRANSACTION %s [, ...]\nSET TRANSACTION SNAPSHOT %s\nSET SESSION CHARACTERISTICS AS TRANSACTION %s [, ...]\n\n%s\n\n    ISOLATION LEVEL { SERIALIZABLE | REPEATABLE READ | READ COMMITTED | READ UNCOMMITTED }\n    READ WRITE | READ ONLY\n    [ NOT ] DEFERRABLE",_("transaction_mode"), _("snapshot_id"), _("transaction_mode"), _("where transaction_mode is one of:"));
}

static void
sql_help_SHOW(PQExpBuffer buf)
{
  appendPQExpBuffer(buf,"SHOW %s\nSHOW ALL",_("name"));
}

static void
sql_help_START_TRANSACTION(PQExpBuffer buf)
{
  appendPQExpBuffer(buf,"START TRANSACTION [ %s [, ...] ]\n\n%s\n\n    ISOLATION LEVEL { SERIALIZABLE | REPEATABLE READ | READ COMMITTED | READ UNCOMMITTED }\n    READ WRITE | READ ONLY\n    [ NOT ] DEFERRABLE",_("transaction_mode"), _("where transaction_mode is one of:"));
}
...
{
  appendPQExpBuffer(buf,"TRUNCATE [ TABLE ] [ ONLY ] %s [ * ] [, ... ]\n    [ RESTART IDENTITY | CONTINUE IDENTITY ] [ CASCADE | RESTRICT ]",_("name"));
}
...
{
  appendPQExpBuffer(buf,"[ WITH [ RECURSIVE ] %s [, ...] ]\nUPDATE [ ONLY ] %s [ * ] [ [ AS ] %s ]\n    SET { %s = { %s | DEFAULT } |\n          ( %s [, ...] ) = [ ROW ] ( { %s | DEFAULT } [, ...] ) |\n          ( %s [, ...] ) = ( %s )\n        } [, ...]\n    [ FROM %s [, ...] ]\n    [ WHERE %s | WHERE CURRENT OF %s ]\n    [ RETURNING * | %s [ [ AS ] %s ] [, ...] ]",_("with_query"), _("table_name"), _("alias"), _("column_name"), _("expression"), _("column_name"), _("expression"), _("column_name"), _("sub-SELECT"), _("from_item"), _("condition"), _("cursor_name"), _("output_expression"), _("output_name"));
}

static void
sql_help_VACUUM(PQExpBuffer buf)
{
  appendPQExpBuffer(buf,"VACUUM [ ( %s [, ...] ) ] [ %s [, ...] ]\nVACUUM [ FULL ] [ FREEZE ] [ VERBOSE ] [ ANALYZE ] [ %s [, ...] ]\n\n%s\n\n    FULL [ %s ]\n    FREEZE [ %s ]\n    VERBOSE [ %s ]\n    ANALYZE [ %s ]\n    DISABLE_PAGE_SKIPPING [ %s ]\n    SKIP_LOCKED [ %s ]\n    INDEX_CLEANUP [ %s ]\n    TRUNCATE [ %s ]\n\n%s\n\n    %s [ ( %s [, ...] ) ]",_("option"), _("table_and_columns"), _("table_and_columns"), _("where option can be one of:"), _("boolean"), _("boolean"), _("boolean"), _("boolean"), _("boolean"), _("boolean"), _("boolean"), _("boolean"), _("and table_and_columns is:"), _("table_name"), _("column_name"));
}

static void
sql_help_VALUES(PQExpBuffer buf)
{
  appendPQExpBuffer(buf,"VALUES ( %s [, ...] ) [, ...]\n    [ ORDER BY %s [ ASC | DESC | USING %s ] [, ...] ]\n    [ LIMIT { %s | ALL } ]\n    [ OFFSET %s [ ROW | ROWS ] ]\n    [ FETCH { FIRST | NEXT } [ %s ] { ROW | ROWS } ONLY ]",_("expression"), _("sort_expression"), _("operator"), _("count"), _("start"), _("count"));
}
