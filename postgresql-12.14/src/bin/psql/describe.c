...
describeAccessMethods(const char *pattern, bool verbose)
{
  ...
  printfPQExpBuffer(&buf,
      ...
      " WHEN 't' THEN '%s'"
      " END AS \"%s\"",
      gettext_noop("Name"), gettext_noop("Index"), gettext_noop("Table"), gettext_noop("Type"));
  ...
  if (verbose)
  {
    appendPQExpBuffer(&buf,
        ...
        gettext_noop("Handler"), gettext_noop("Description"));
  }
...
describeTablespaces(const char *pattern, bool verbose)
{
  ...
  if (pset.sversion >= 90200)
  {
    printfPQExpBuffer(&buf,
        ...
        gettext_noop("Name"), gettext_noop("Owner"), gettext_noop("Location"));
  }
  else
  {
    printfPQExpBuffer(&buf,
...
describeFunctions(const char *functypes, const char *pattern, bool verbose, bool showSystem)
{
  ...
  if (pset.sversion >= 110000)
  {
    appendPQExpBuffer(&buf,
        ...
        "  ELSE '%s'\n"
        " END as \"%s\"",
        gettext_noop("Result data type"), gettext_noop("Argument data types"),
  ...
  if (verbose)
  {
    appendPQExpBuffer(&buf,
        ...
        " END as \"%s\"",
        gettext_noop("immutable"), gettext_noop("stable"), gettext_noop("volatile"), gettext_noop("Volatility"));
    if (pset.sversion >= 90600)
    {
      appendPQExpBuffer(&buf,
          ",\n CASE\n"
          ...
          " END as \"%s\"",
          gettext_noop("restricted"), gettext_noop("safe"), gettext_noop("unsafe"), gettext_noop("Parallel"));
    }
    appendPQExpBuffer(&buf,
        ",\n pg_catalog.pg_get_userbyid(p.proowner) as \"%s\""
        ",\n CASE WHEN prosecdef THEN '%s' ELSE '%s' END AS \"%s\"",
        gettext_noop("Owner"), gettext_noop("definer"), gettext_noop("invoker"), gettext_noop("Security"));
    appendPQExpBufferStr(&buf, ",\n ");
    ...
    appendPQExpBuffer(&buf,
        ...
        ",\n p.prosrc as \"%s\""
        ",\n pg_catalog.obj_description(p.oid, 'pg_proc') as \"%s\"",
        gettext_noop("Language"), gettext_noop("Source code"), gettext_noop("Description"));
  }
...
describeTypes(const char *pattern, bool verbose, bool showSystem)
{
  ...
  appendPQExpBufferStr(&buf, "OR (SELECT c.relkind = " CppAsString2(RELKIND_COMPOSITE_TYPE) " FROM pg_catalog.pg_class c "
...
describeOneTableDetails(const char *schemaname, const char *relationname, const char *oid, bool verbose)
{
  ...
  else if (pset.sversion >= 80200)
  {
    printfPQExpBuffer(&buf,
        ...
        (verbose ? "pg_catalog.array_to_string(reloptions, E', ')" : "''"), oid);
  }
  ...
  if (tableinfo.relkind == RELKIND_INDEX || tableinfo.relkind == RELKIND_PARTITIONED_INDEX)
  {
    ...
    if (pset.sversion >= 90000)
    {
      appendPQExpBufferStr(&buf, "  (NOT i.indimmediate) AND "
  ...
  else if (tableinfo.relkind == RELKIND_RELATION || tableinfo.relkind == RELKIND_MATVIEW || tableinfo.relkind == RELKIND_FOREIGN_TABLE || tableinfo.relkind == RELKIND_PARTITIONED_TABLE)
  {
    ...
    if (tableinfo.hasindex)
    {
      ...
      if (pset.sversion >= 90000)
      {
        appendPQExpBufferStr(&buf, "pg_catalog.pg_get_constraintdef(con.oid, true), "
                                   "contype, condeferrable, condeferred");
      }
      else
      {
        appendPQExpBufferStr(&buf, "null AS constraintdef, null AS contype, "
  ...
  if (tableinfo.hastriggers)
  {
    ...
    {
      appendPQExpBufferStr(&buf, "(NOT tgisconstraint "
                                 " OR NOT EXISTS"
  ...
  if (tableinfo.relkind == RELKIND_RELATION || tableinfo.relkind == RELKIND_MATVIEW || tableinfo.relkind == RELKIND_FOREIGN_TABLE || tableinfo.relkind == RELKIND_PARTITIONED_TABLE)
  {
    ...
    printfPQExpBuffer(&buf,
        ...
        " AND c.relkind != " CppAsString2(RELKIND_PARTITIONED_TABLE) " ORDER BY inhseqno;",
        oid);
...
listTables(const char *tabtypes, const char *pattern, bool verbose, bool showSystem)
{
  ...
  printfPQExpBuffer(&buf,
      ...
      gettext_noop("Schema"), gettext_noop("Name"), gettext_noop("table"), gettext_noop("view"), gettext_noop("materialized view"), gettext_noop("index"), gettext_noop("sequence"), gettext_noop("special"), gettext_noop("foreign table"), gettext_noop("partitioned table"), gettext_noop("partitioned index"), gettext_noop("Type"), gettext_noop("Owner"));
  ...
  if (mixed_output)
  {
    appendPQExpBuffer(&buf,
        ...
        " WHEN " CppAsString2(RELKIND_PARTITIONED_TABLE) " THEN '%s'"
                                                         " WHEN " CppAsString2(RELKIND_PARTITIONED_INDEX) " THEN '%s'"
                                                                                                          " END as \"%s\"",
        gettext_noop("partitioned table"), gettext_noop("partitioned index"), gettext_noop("Type"));
...
listDomains(const char *pattern, bool verbose, bool showSystem)
{
  ...
  appendPQExpBuffer(&buf,
      ...
      "       ), ' ') as \"%s\"",
      gettext_noop("Nullable"), gettext_noop("Default"), gettext_noop("Check"));
...
listConversions(const char *pattern, bool verbose, bool showSystem)
{
  ...
  printfPQExpBuffer(&buf,
      ...
      "       ELSE '%s' END AS \"%s\"",
      gettext_noop("Schema"), gettext_noop("Name"), gettext_noop("Source"), gettext_noop("Destination"), gettext_noop("yes"), gettext_noop("no"), gettext_noop("Default?"));
...
listEventTriggers(const char *pattern, bool verbose)
{
  ...
  printfPQExpBuffer(&buf,
      ...
      gettext_noop("Name"), gettext_noop("Event"), gettext_noop("Owner"), gettext_noop("enabled"), gettext_noop("replica"), gettext_noop("always"), gettext_noop("disabled"), gettext_noop("Enabled"), gettext_noop("Function"), gettext_noop("Tags"));
  if (verbose)
  {
...
listCasts(const char *pattern, bool verbose)
{
  ...
  appendPQExpBuffer(&buf,
      ...
      "            ELSE '%s'\n"
      "       END AS \"%s\"",
      COERCION_CODE_EXPLICIT, gettext_noop("no"), COERCION_CODE_ASSIGNMENT, gettext_noop("in assignment"), gettext_noop("yes"), gettext_noop("Implicit?"));
...
listCollations(const char *pattern, bool verbose, bool showSystem)
{
  ...
  printfPQExpBuffer(&buf,
      ...
      "       c.collcollate AS \"%s\",\n"
      "       c.collctype AS \"%s\"",
      gettext_noop("Schema"), gettext_noop("Name"), gettext_noop("Collate"), gettext_noop("Ctype"));
...
describeOneTSParser(const char *oid, const char *nspname, const char *prsname)
{
  ...
  printfPQExpBuffer(&buf,
      ...
      " FROM pg_catalog.pg_ts_parser p\n"
      " WHERE p.oid = '%s';",
      gettext_noop("Start parse"), gettext_noop("Method"), gettext_noop("Function"), gettext_noop("Description"), oid, gettext_noop("Get next token"), oid, gettext_noop("End parse"), oid, gettext_noop("Get headline"), oid, gettext_noop("Get token types"), oid);
  ...
  printfPQExpBuffer(&buf,
      ...
      "ORDER BY 1;",
      gettext_noop("Token name"), gettext_noop("Description"), oid);
...
describeOneTSConfig(const char *oid, const char *nspname, const char *cfgname, const char *pnspname, const char *prsname)
{
  ...
  printfPQExpBuffer(&buf,
      ...
      "ORDER BY 1;",
      gettext_noop("Token"), gettext_noop("Dictionaries"), oid);
...
listForeignServers(const char *pattern, bool verbose)
{
  ...
  printfPQExpBuffer(&buf,
      ...
      "  f.fdwname AS \"%s\"",
      gettext_noop("Name"), gettext_noop("Owner"), gettext_noop("Foreign-data wrapper"));
  ...
  if (verbose)
  {
    ...
    appendPQExpBuffer(&buf,
        ...
        "  END AS \"%s\",\n"
        "  d.description AS \"%s\"",
        gettext_noop("Type"), gettext_noop("Version"), gettext_noop("FDW options"), gettext_noop("Description"));
  }
...
listUserMappings(const char *pattern, bool verbose)
{
  ...
  printfPQExpBuffer(&buf,
      ...
      "  um.usename AS \"%s\"",
      gettext_noop("Server"), gettext_noop("User name"));
...
listForeignTables(const char *pattern, bool verbose)
{
  ...
  printfPQExpBuffer(&buf,
      ...
      "  c.relname AS \"%s\",\n"
      "  s.srvname AS \"%s\"",
      gettext_noop("Schema"), gettext_noop("Table"), gettext_noop("Server"));
  ...
  if (verbose)
  {
    appendPQExpBuffer(&buf,
        ...
        "  END AS \"%s\",\n"
        "  d.description AS \"%s\"",
        gettext_noop("FDW options"), gettext_noop("Description"));
  }
...
listOneExtensionContents(const char *extname, const char *oid)
{
  ...
  printfPQExpBuffer(&buf,
      ...
      "ORDER BY 1;",
      gettext_noop("Object description"), oid);
...
listPublications(const char *pattern)
{
  ...
  printfPQExpBuffer(&buf,
      ...
      "  pubupdate AS \"%s\",\n"
      "  pubdelete AS \"%s\"",
      gettext_noop("Name"), gettext_noop("Owner"), gettext_noop("All tables"), gettext_noop("Inserts"), gettext_noop("Updates"), gettext_noop("Deletes"));
  if (pset.sversion >= 110000)
  {
