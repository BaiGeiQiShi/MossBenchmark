...
static const SchemaQuery Query_for_list_of_datatypes = {
    ...
    .selcondition = "(t.typrelid = 0 "
                    " OR (SELECT c.relkind = " CppAsString2(
                        RELKIND_COMPOSITE_TYPE) "     FROM pg_catalog.pg_class "
...
static const SchemaQuery Query_for_list_of_composite_datatypes = {
    ...
    .selcondition = "(SELECT c.relkind = " CppAsString2(
        RELKIND_COMPOSITE_TYPE) " FROM pg_catalog.pg_class c WHERE c.oid = "
                                "t.typrelid) "
                                "AND t.typname !~ '^_'",
    .viscondition = "pg_catalog.pg_type_is_visible(t.oid)",
    .namespace = "t.typnamespace",
...
static const SchemaQuery Query_for_list_of_tables = {
    ...
    .selcondition = "c.relkind IN (" CppAsString2(
        RELKIND_RELATION) ", " CppAsString2(RELKIND_PARTITIONED_TABLE) ")",
    .viscondition = "pg_catalog.pg_table_is_visible(c.oid)",
    .namespace = "c.relnamespace",
    .result = "pg_catalog.quote_ident(c.relname)",
};
...
static const SchemaQuery Query_for_list_of_indexes = {
    .catname = "pg_catalog.pg_class c",
    .selcondition = "c.relkind IN (" CppAsString2(
        RELKIND_INDEX) ", " CppAsString2(RELKIND_PARTITIONED_INDEX) ")",
    .viscondition = "pg_catalog.pg_table_is_visible(c.oid)",
    .namespace = "c.relnamespace",
    .result = "pg_catalog.quote_ident(c.relname)",
};
...
static const SchemaQuery Query_for_list_of_partitioned_relations = {
    .catname = "pg_catalog.pg_class c",
    .selcondition = "c.relkind IN (" CppAsString2(
        RELKIND_PARTITIONED_TABLE) ", " CppAsString2(RELKIND_PARTITIONED_INDEX) ")",
    .viscondition = "pg_catalog.pg_table_is_visible(c.oid)",
    .namespace = "c.relnamespace",
    .result = "pg_catalog.quote_ident(c.relname)",
};
...
static const SchemaQuery Query_for_list_of_updatables = {
    .catname = "pg_catalog.pg_class c",
    .selcondition =
        "c.relkind IN (" CppAsString2(RELKIND_RELATION) ", " CppAsString2(RELKIND_FOREIGN_TABLE) ", " CppAsString2(
            RELKIND_VIEW) ", " CppAsString2(RELKIND_PARTITIONED_TABLE) ")",
    .viscondition = "pg_catalog.pg_table_is_visible(c.oid)",
    .namespace = "c.relnamespace",
    .result = "pg_catalog.quote_ident(c.relname)",
};
...
static const SchemaQuery Query_for_list_of_selectables = {
    .catname = "pg_catalog.pg_class c",
    .selcondition =
        "c.relkind IN (" CppAsString2(RELKIND_RELATION) ", " CppAsString2(RELKIND_SEQUENCE) ", " CppAsString2(RELKIND_VIEW) ", " CppAsString2(
            RELKIND_MATVIEW) ", " CppAsString2(RELKIND_FOREIGN_TABLE) ","
...
static const SchemaQuery Query_for_list_of_analyzables = {
    .catname = "pg_catalog.pg_class c",
    .selcondition =
        "c.relkind IN (" CppAsString2(RELKIND_RELATION) ", " CppAsString2(RELKIND_PARTITIONED_TABLE) ", " CppAsString2(
            RELKIND_MATVIEW) ", " CppAsString2(RELKIND_FOREIGN_TABLE) ")",
    .viscondition = "pg_catalog.pg_table_is_visible(c.oid)",
    .namespace = "c.relnamespace",
    .result = "pg_catalog.quote_ident(c.relname)",
...
static const SchemaQuery Query_for_list_of_indexables = {
    .catname = "pg_catalog.pg_class c",
    .selcondition =
        "c.relkind IN (" CppAsString2(RELKIND_RELATION) ", " CppAsString2(
...
static const SchemaQuery Query_for_list_of_vacuumables = {
    .catname = "pg_catalog.pg_class c",
    .selcondition = "c.relkind IN (" CppAsString2(
        RELKIND_RELATION) ", " CppAsString2(RELKIND_MATVIEW) ")",
    .viscondition = "pg_catalog.pg_table_is_visible(c.oid)",
    .namespace = "c.relnamespace",
    .result = "pg_catalog.quote_ident(c.relname)",
};
...
static const pgsql_thing_t words_after_create[] = {
    ...
    {"CAST", NULL, NULL, NULL}, /* Casts have complex structures for names, so
                                 * skip it */
    {"COLLATION",
     "SELECT pg_catalog.quote_ident(collname) FROM pg_catalog.pg_collation "
     "WHERE collencoding IN (-1, "
     ...
     */
    {"CONFIGURATION", Query_for_list_of_ts_configurations, NULL, NULL,
     THING_NO_SHOW},
    {"CONVERSION",
     "SELECT pg_catalog.quote_ident(conname) FROM pg_catalog.pg_conversion "
     "WHERE substring(pg_catalog.quote_ident(conname),1,%d)='%s'"},
    ...
    {"OPERATOR", NULL, NULL, NULL}, /* Querying for this is probably not such
                                     * a good idea. */
    {"OWNED", NULL, NULL, NULL,
     THING_NO_CREATE | THING_NO_ALTER}, /* for DROP OWNED BY ... */
    ...
    {"RULE", "SELECT pg_catalog.quote_ident(rulename) FROM pg_catalog.pg_rules "
    ...
    {"TEMP", NULL, NULL, NULL,
     THING_NO_DROP | THING_NO_ALTER}, /* for CREATE TEMP TABLE
                                       * ... */
    {"TEMPLATE", Query_for_list_of_ts_templates, NULL, NULL, THING_NO_SHOW},
    {"TEMPORARY", NULL, NULL, NULL,
     THING_NO_DROP | THING_NO_ALTER}, /* for CREATE TEMPORARY
                                       * TABLE ... */
    {"TEXT SEARCH", NULL, NULL, NULL},
    {"TRANSFORM", NULL, NULL, NULL},
    {"TRIGGER",
     "SELECT pg_catalog.quote_ident(tgname) FROM pg_catalog.pg_trigger WHERE "
     "substring(pg_catalog.quote_ident(tgname),1,%d)='%s' AND NOT "
     "tgisinternal"},
    {"TYPE", NULL, NULL, &Query_for_list_of_datatypes},
    {"UNIQUE", NULL, NULL, NULL,
     THING_NO_DROP | THING_NO_ALTER}, /* for CREATE UNIQUE
                                       * INDEX ... */
    {"UNLOGGED", NULL, NULL, NULL,
     THING_NO_DROP | THING_NO_ALTER}, /* for CREATE UNLOGGED
                                       * TABLE ... */
...
static void append_variable_names(char ***varnames, int *nvars, int *maxvars,
                                  const char *varname, const char *prefix,
                                  const char *suffix);
static char **complete_from_variables(const char *text, const char *prefix,
                                      const char *suffix, bool need_value);
...
static bool word_matches(const char *pattern, const char *word,
                         bool case_sensitive) {
  size_t wordlen;
 ...
 */
static bool TailMatchesImpl(bool case_sensitive, int previous_words_count,
                            char **previous_words, int narg, ...) {
  va_list args;
 ...
 * in previous_words match the variadic arguments?
 */
static bool MatchesImpl(bool case_sensitive, int previous_words_count,
                        char **previous_words, int narg, ...) {
  va_list args;
 ...
 */
static bool HeadMatchesImpl(bool case_sensitive, int previous_words_count,
                            char **previous_words, int narg, ...) {
  va_list args;
...
#define HeadMatchesCS(...)                                                     \
  ...
  static const char *const sql_commands[] = {"ABORT",
                                             "ALTER",
                                             "ANALYZE",
                                             "BEGIN",
                                             "CALL",
  ...
  static const char *const backslash_commands[] = {
      "\\a",         "\\connect",    "\\conninfo",  "\\C",
      "\\cd",        "\\copy",       "\\copyright", "\\crosstabview",
      "\\d",         "\\da",         "\\dA",        "\\db",
      "\\dc",        "\\dC",         "\\dd",        "\\ddp",
      "\\dD",        "\\des",        "\\det",       "\\deu",
      "\\dew",       "\\dE",         "\\df",        "\\dF",
      ...
      "\\dt",        "\\dT",         "\\dv",        "\\du",
      "\\dx",        "\\dy",         "\\e",         "\\echo",
      "\\ef",        "\\elif",       "\\else",      "\\encoding",
      "\\endif",     "\\errverbose", "\\ev",        "\\f",
      "\\g",         "\\gdesc",      "\\gexec",     "\\gset",
      "\\gx",        "\\h",          "\\help",      "\\H",
      "\\i",         "\\if",         "\\ir",        "\\l",
   ...
   */
  previous_words =
      get_previous_words(start, &words_buffer, &previous_words_count);
  ...
  /* ALTER PUBLICATION <name> SET ( */
  else if (HeadMatches("ALTER", "PUBLICATION", MatchAny) &&
           TailMatches("SET", "(")) {
    COMPLETE_WITH("publish");
  }
  /* ALTER SUBSCRIPTION <name> */
  else if (Matches("ALTER", "SUBSCRIPTION", MatchAny)) {
    COMPLETE_WITH("CONNECTION", "ENABLE", "DISABLE", "OWNER TO", "RENAME TO",
                  "REFRESH PUBLICATION", "SET");
  }
  ...
  /* ALTER DATABASE <name> */
    ...
    COMPLETE_WITH("RESET", "SET", "OWNER TO", "RENAME TO", "IS_TEMPLATE",
  ...
  /* ALTER FOREIGN TABLE <name> */
    ...
    COMPLETE_WITH("ADD", "ALTER", "DISABLE TRIGGER", "DROP", "ENABLE",
                  "INHERIT", "NO INHERIT", "OPTIONS", "OWNER TO", "RENAME",
                  "SET", "VALIDATE CONSTRAINT");
  }
  ...
  /* ALTER INDEX <name> */
    ...
    COMPLETE_WITH("ALTER COLUMN", "OWNER TO", "RENAME TO", "SET", "RESET",
                  "ATTACH PARTITION");
  ...
  /* ALTER INDEX <foo> SET|RESET ( */
    ...
    COMPLETE_WITH(
        "fillfactor =", "vacuum_cleanup_index_scale_factor =", /* BTREE */
        "fastupdate =", "gin_pending_list_limit =",            /* GIN */
        "buffering =",                                         /* GiST */
        "pages_per_range =", "autosummarize ="                 /* BRIN */
    );
  ...
  /* ALTER USER,ROLE <name> */
    ...
    COMPLETE_WITH("BYPASSRLS", "CONNECTION LIMIT", "CREATEDB", "CREATEROLE",
                  ...
                  "NOREPLICATION", "NOSUPERUSER", "PASSWORD", "RENAME TO",
                  "REPLICATION", "RESET", "SET", "SUPERUSER", "VALID UNTIL",
                  "WITH");
  }
  ...
  /* ALTER DEFAULT PRIVILEGES IN SCHEMA ... FOR ROLE|USER ... */
           ...
           Matches("ALTER", "DEFAULT", "PRIVILEGES", "IN", "SCHEMA", MatchAny,
  ...
  else if (Matches("ALTER", "DOMAIN", MatchAny, "DROP|RENAME|VALIDATE",
                   "CONSTRAINT")) {
    completion_info_charp = prev3_wd;
  ...
  else if (Matches("ALTER", "DOMAIN", MatchAny, "RENAME", "CONSTRAINT",
                   MatchAny)) {
    COMPLETE_WITH("TO");
  }
  ...
  /* ALTER SEQUENCE <name> */
    ...
    COMPLETE_WITH("INCREMENT", "MINVALUE", "MAXVALUE", "RESTART", "NO", "CACHE",
                  "CYCLE", "SET SCHEMA", "OWNED BY", "OWNER TO", "RENAME TO");
  }
  ...
  else if (Matches("ALTER", "POLICY", MatchAny, "ON", MatchAny, "WITH",
                   "CHECK")) {
    COMPLETE_WITH("(");
  }
   ...
   */
    ...
    COMPLETE_WITH("ADD", "ALTER", "CLUSTER ON", "DISABLE", "DROP", "ENABLE",
                  "INHERIT", "NO INHERIT", "RENAME", "RESET", "OWNER TO", "SET",
  ...
  } else if (Matches("ALTER", "TABLE", MatchAny, "ENABLE", MatchAny,
                     "TRIGGER")) {
    completion_info_charp = prev4_wd;
    COMPLETE_WITH_QUERY(Query_for_trigger_of_table);
  }
  ...
  /* ALTER TABLE xxx RENAME yyy */
                   ...
                   MatchAnyExcept("CONSTRAINT|TO"))) {
    COMPLETE_WITH("TO");
  }

  /* ALTER TABLE xxx RENAME COLUMN/CONSTRAINT yyy */
  else if (Matches("ALTER", "TABLE", MatchAny, "RENAME", "COLUMN|CONSTRAINT",
                   MatchAnyExcept("TO"))) {
    COMPLETE_WITH("TO");
  }
   ...
   */
  else if (Matches("ALTER", "TABLE", MatchAny, "ALTER|DROP|RENAME|VALIDATE",
                   "CONSTRAINT")) {
    completion_info_charp = prev3_wd;
  ...
  /* If we have ALTER TABLE <sth> SET, provide list of attributes and '(' */
    ...
    COMPLETE_WITH("(", "LOGGED", "SCHEMA", "TABLESPACE", "UNLOGGED", "WITH",
                  "WITHOUT");
  }
  ...
  /* ALTER TEXT SEARCH */
    ...
    COMPLETE_WITH("ADD MAPPING FOR", "ALTER MAPPING", "DROP MAPPING FOR",
  ...
  else if (Matches("ALTER", "TYPE", MatchAny, "RENAME", "ATTRIBUTE|VALUE",
                   MatchAny)) {
    COMPLETE_WITH("TO");
  }
   ...
   * of attributes
   */
  else if (Matches("ALTER", "TYPE", MatchAny, "ALTER|DROP|RENAME",
                   "ATTRIBUTE")) {
    COMPLETE_WITH_ATTR(prev3_wd, "");
  }
  ...
  /* COMMENT */
    ...
    COMPLETE_WITH(
        ...
        "EVENT TRIGGER", "EXTENSION", "FOREIGN DATA WRAPPER", "FOREIGN TABLE",
        "SERVER", "INDEX", "LANGUAGE", "POLICY", "PUBLICATION", "RULE",
        "SCHEMA", "SEQUENCE", "STATISTICS", "SUBSCRIPTION", "TABLE", "TYPE",
        "VIEW", "MATERIALIZED VIEW", "COLUMN", "AGGREGATE", "FUNCTION",
        "PROCEDURE", "ROUTINE", "OPERATOR", "TRIGGER", "CONSTRAINT", "DOMAIN",
    ...
    COMPLETE_WITH_QUERY(Query_for_list_of_event_triggers);
             ...
             Matches("COMMENT", "ON", MatchAny, MatchAny,
                     MatchAnyExcept("IS")) ||
             Matches("COMMENT", "ON", MatchAny, MatchAny, MatchAny,
                     MatchAnyExcept("IS"))) {
    COMPLETE_WITH("IS");
  }
  ...
  /* If we have COPY (, complete it with legal commands */
    ...
    COMPLETE_WITH("SELECT", "TABLE", "VALUES", "INSERT", "UPDATE", "DELETE",
                  "WITH");
  }
  ...
  /* CREATE DATABASE */
    ...
    COMPLETE_WITH("OWNER", "TEMPLATE", "ENCODING", "TABLESPACE", "IS_TEMPLATE",
                  "ALLOW_CONNECTIONS", "CONNECTION LIMIT", "LC_COLLATE",
                  "LC_CTYPE");
  }
  ...
  /* Complete USING with an index method */
    ...
    COMPLETE_WITH_QUERY(Query_for_list_of_index_access_methods);
             ...
             !TailMatches("POLICY", MatchAny, MatchAny, MatchAny, MatchAny,
                          MatchAny) &&
  ...
  /* Complete CREATE TABLE name (...) with supported options */
    ...
    COMPLETE_WITH("INHERITS (", "PARTITION BY", "USING", "TABLESPACE",
                  "WITH (");
  } else if (TailMatches("CREATE", "TEMP|TEMPORARY", "TABLE", MatchAny,
                         "(*)")) {
    COMPLETE_WITH("INHERITS (", "ON COMMIT", "PARTITION BY", "TABLESPACE",
                  "WITH (");
  }
  ...
  /* CREATE SUBSCRIPTION */
    ...
    /* complete with nothing here as this refers to remote publications */
             ...
             TailMatches("PUBLICATION", MatchAny)) {
    COMPLETE_WITH("WITH (");
  }
  /* Complete "CREATE SUBSCRIPTION <name> ...  WITH ( <opt>" */
  else if (HeadMatches("CREATE", "SUBSCRIPTION") && TailMatches("WITH", "(")) {
    COMPLETE_WITH("copy_data", "connect", "create_slot", "enabled", "slot_name",
                  "synchronous_commit");
  }
  ...
  /* complete CREATE TRIGGER <name> BEFORE,AFTER sth with OR,ON */
                       ...
                       MatchAny) ||
           TailMatches("CREATE", "TRIGGER", MatchAny, "INSTEAD", "OF",
                       MatchAny)) {
    COMPLETE_WITH("ON", "OR");
  }
  ...
  /* complete CREATE TRIGGER ... INSTEAD OF event ON with a list of views */
  else if (TailMatches("CREATE", "TRIGGER", MatchAny, "INSTEAD", "OF", MatchAny,
                       "ON")) {
    COMPLETE_WITH_SCHEMA_QUERY(Query_for_list_of_views, NULL);
  } else if (HeadMatches("CREATE", "TRIGGER") && TailMatches("ON", MatchAny)) {
    if (pset.sversion >= 110000) {
      COMPLETE_WITH("NOT DEFERRABLE", "DEFERRABLE", "INITIALLY", "REFERENCING",
                    "FOR", "WHEN (", "EXECUTE FUNCTION");
    } else {
      COMPLETE_WITH("NOT DEFERRABLE", "DEFERRABLE", "INITIALLY", "REFERENCING",
                    "FOR", "WHEN (", "EXECUTE PROCEDURE");
    }
  } else if (HeadMatches("CREATE", "TRIGGER") &&
             (TailMatches("DEFERRABLE") ||
              TailMatches("INITIALLY", "IMMEDIATE|DEFERRED"))) {
    if (pset.sversion >= 110000) {
    ...
    if (pset.sversion >= 110000) {
      ...
      COMPLETE_WITH("OLD TABLE", "FOR", "WHEN (", "EXECUTE PROCEDURE");
             ...
             (TailMatches("REFERENCING", "OLD|NEW", "TABLE", "AS", MatchAny,
                          "OLD|NEW", "TABLE", "AS", MatchAny) ||
              TailMatches("REFERENCING", "OLD|NEW", "TABLE", MatchAny,
                          "OLD|NEW", "TABLE", "AS", MatchAny) ||
              TailMatches("REFERENCING", "OLD|NEW", "TABLE", "AS", MatchAny,
  ...
  /* CREATE ROLE,USER,GROUP <name> */
    ...
    COMPLETE_WITH("ADMIN", "BYPASSRLS", "CONNECTION LIMIT", "CREATEDB",
                  "CREATEROLE", "ENCRYPTED PASSWORD", "IN", "INHERIT", "LOGIN",
                  "NOBYPASSRLS", "NOCREATEDB", "NOCREATEROLE", "NOINHERIT",
                  "NOLOGIN", "NOREPLICATION", "NOSUPERUSER", "PASSWORD",
                  "REPLICATION", "ROLE", "SUPERUSER", "SYSID", "VALID UNTIL",
                  "WITH");
  }
  ...
  /* Complete DROP object with CASCADE / RESTRICT */
               ...
               "DROP",
               "COLLATION|CONVERSION|DOMAIN|EXTENSION|LANGUAGE|PUBLICATION|"
               "SCHEMA|SEQUENCE|SERVER|SUBSCRIPTION|STATISTICS|TABLE|TYPE|VIEW",
               MatchAny) ||
           Matches("DROP", "ACCESS", "METHOD", MatchAny) ||
           (Matches("DROP", "AGGREGATE|FUNCTION|PROCEDURE|ROUTINE", MatchAny,
                    MatchAny) &&
            ends_with(prev_wd, ')')) ||
           Matches("DROP", "EVENT", "TRIGGER", MatchAny) ||
           Matches("DROP", "FOREIGN", "DATA", "WRAPPER", MatchAny) ||
           Matches("DROP", "FOREIGN", "TABLE", MatchAny) ||
           Matches("DROP", "TEXT", "SEARCH",
   ...
   */
    ...
    COMPLETE_WITH("SELECT", "INSERT", "DELETE", "UPDATE", "DECLARE", "ANALYZE",
                  "VERBOSE");
     ...
     */
    if (ends_with(prev_wd, '(') || ends_with(prev_wd, ',')) {
      COMPLETE_WITH("ANALYZE", "VERBOSE", "COSTS", "SETTINGS", "BUFFERS",
                    "TIMING", "SUMMARY", "FORMAT");
    } else if (TailMatches(
                   "ANALYZE|VERBOSE|COSTS|SETTINGS|BUFFERS|TIMING|SUMMARY")) {
      COMPLETE_WITH("ON", "OFF");
  ...
  } else if (Matches("EXPLAIN", "(*)") || Matches("EXPLAIN", "VERBOSE") ||
  ...
  /* Complete GRANT/REVOKE with a list of roles and privileges */
    ...
    if (HeadMatches("ALTER", "DEFAULT", "PRIVILEGES")) {
      COMPLETE_WITH("SELECT", "INSERT", "UPDATE", "DELETE", "TRUNCATE",
                    "REFERENCES", "TRIGGER", "EXECUTE", "USAGE", "ALL");
    } else {
   ...
   */
    ...
    if (TailMatches("SELECT|INSERT|UPDATE|DELETE|TRUNCATE|REFERENCES|TRIGGER|"
                    "CREATE|CONNECT|TEMPORARY|TEMP|EXECUTE|USAGE|ALL")) {
      COMPLETE_WITH("ON");
   ...
   */
    ...
    COMPLETE_WITH("FUNCTIONS IN SCHEMA", "PROCEDURES IN SCHEMA",
                  "ROUTINES IN SCHEMA", "SEQUENCES IN SCHEMA",
                  "TABLES IN SCHEMA");
  ...
  else if (TailMatches("GRANT|REVOKE", MatchAny, "ON", "ALL", MatchAny, "IN",
                       "SCHEMA", MatchAny)) {
  ...
  else if (TailMatches("GRANT|REVOKE", MatchAny, "ON", "FOREIGN", "DATA",
                       "WRAPPER", MatchAny)) {
    if (TailMatches("GRANT", MatchAny, MatchAny, MatchAny, MatchAny, MatchAny,
                    MatchAny)) {
      COMPLETE_WITH("TO");
  ...
  else if (TailMatches("GRANT|REVOKE", MatchAny, "ON", "FOREIGN", "SERVER",
                       MatchAny)) {
   ...
   */
    ...
    COMPLETE_WITH("(", "DEFAULT VALUES", "SELECT", "TABLE", "VALUES",
                  "OVERRIDING");
  }
  ...
  /* Complete LOCK [TABLE] <table> IN with a lock mode */
    ...
    COMPLETE_WITH("ACCESS SHARE MODE", "ROW SHARE MODE", "ROW EXCLUSIVE MODE",
  ...
  /* NOTIFY --- can be inside EXPLAIN, RULE, etc */
    ...
    COMPLETE_WITH_QUERY("SELECT pg_catalog.quote_ident(channel) FROM "
                        "pg_catalog.pg_listening_channels() AS channel WHERE "
  ...
  /* SECURITY LABEL */
    ...
    COMPLETE_WITH("TABLE", "COLUMN", "AGGREGATE", "DATABASE", "DOMAIN",
                  ...
                  "MATERIALIZED VIEW", "LANGUAGE", "PUBLICATION", "PROCEDURE",
                  "ROLE", "ROUTINE", "SCHEMA", "SEQUENCE", "SUBSCRIPTION",
                  "TABLESPACE", "TYPE", "VIEW");
  ...
  /* Complete "SET TRANSACTION" */
    ...
    COMPLETE_WITH("SNAPSHOT", "ISOLATION LEVEL", "READ", "DEFERRABLE",
                  "NOT DEFERRABLE");
  } else if (Matches("BEGIN|START", "TRANSACTION") ||
             Matches("BEGIN", "WORK") || Matches("BEGIN") ||
             Matches("SET", "SESSION", "CHARACTERISTICS", "AS",
                     "TRANSACTION")) {
   ...
   */
           ...
           TailMatches("SET", MatchAny) && !TailMatches("SCHEMA")) {
   ...
   */
    ...
    if (TailMatches("DateStyle", "TO|=")) {
      COMPLETE_WITH("ISO", "SQL", "Postgres", "German", "YMD", "DMY", "MDY",
                    "US", "European", "NonEuropean", "DEFAULT");
      ...
      if (guctype) {
        if (strcmp(guctype, "enum") == 0) {
          ...
          COMPLETE_WITH("on", "off", "true", "false", "yes", "no", "1", "0",
                        "DEFAULT");
        } else {
  ...
  } else if (Matches("CREATE|ALTER", "USER", "MAPPING", "FOR", MatchAny,
                     "SERVER", MatchAny)) {
    COMPLETE_WITH("OPTIONS");
  }
   ...
   */
    ...
    if (ends_with(prev_wd, '(') || ends_with(prev_wd, ',')) {
      COMPLETE_WITH("FULL", "FREEZE", "ANALYZE", "VERBOSE",
                    ...
                    "TRUNCATE");
    } else if (TailMatches("FULL|FREEZE|ANALYZE|VERBOSE|DISABLE_PAGE_SKIPPING|"
                           "SKIP_LOCKED|INDEX_CLEANUP|TRUNCATE")) {
      COMPLETE_WITH("ON", "OFF");
    }
  ...
  /* must be at end of \d alternatives: */
    ...
    COMPLETE_WITH_CS("border", "columns", "csv_fieldsep", "expanded",
                     ...
                     "linestyle", "null", "numericlocale", "pager",
 ...
 */
static char *create_or_drop_command_generator(const char *text, int state,
                                              bits32 excluded) {
...
static char *complete_from_versioned_schema_query(const char *text, int state) {
  ...
  return _complete_from_query(vquery ? vquery->query : NULL, squery, text,
                              state);
}
  ...
  if (state == 0) {
    ...
    if (schema_query) {
      ...
      appendPQExpBuffer(&query_buffer, "substring(%s,1,%d)='%s'",
                        schema_query->result, char_length, e_text);
       ...
       */
      if (strcmp(schema_query->catname, "pg_catalog.pg_class c") == 0 &&
      ...
      appendPQExpBuffer(
          ...
          " substring('%s',1,pg_catalog.length(pg_catalog.quote_ident(nspname))"
          "+1)) > 1",
          char_length, e_text);
      ...
      appendPQExpBuffer(&query_buffer,
                        ...
                        "WHERE %s = n.oid AND ",
                        qualresult, schema_query->catname,
      ...
      appendPQExpBuffer(
          ...
          " substring('%s',1,pg_catalog.length(pg_catalog.quote_ident(n."
          "nspname))+1)",
          char_length, e_text);
      appendPQExpBuffer(
          &query_buffer,
      ...
      appendPQExpBuffer(&query_buffer, simple_query, char_length, e_text,
                        e_info_charp, e_info_charp, e_info_charp2,
                        e_info_charp2);
    }
...
static void append_variable_names(char ***varnames, int *nvars, int *maxvars,
  ...
  if (*nvars >= *maxvars) {
    *maxvars *= 2;
    *varnames =
        (char **)pg_realloc(*varnames, ((*maxvars) + 1) * sizeof(char *));
  }
...
static char **complete_from_variables(const char *text, const char *prefix,
  ...
  for (ptr = pset.vars->next; ptr; ptr = ptr->next) {
    ...
    append_variable_names(&varnames, &nvars, &maxvars, ptr->name, prefix,
                          suffix);
  }
...
static char *complete_from_files(const char *text, int state) {
  ...
  if (state == 0) {
    ...
    unquoted_text = strtokx(text, "", NULL, "'", *completion_charp, false, true,
                            pset.encoding);
