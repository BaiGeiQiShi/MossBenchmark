 ...
 * installations to 1000, but if you still don't like this prospect,* you can turn off tab completion in your ~/.inputrc (or else
 * ${INPUTRC}) file so:
 *
 *	 $if psql
...
static const SchemaQuery Query_for_list_of_aggregates[] = {{
                                                               .min_server_version = 110000,.catname = "pg_catalog.pg_proc p",.selcondition = "p.prokind = 'a'",.viscondition = "pg_catalog.pg_function_is_visible(p.oid)",.namespace = "p.pronamespace",.result = "pg_catalog.quote_ident(p.proname)",},{
        .catname = "pg_catalog.pg_proc p",.selcondition = "p.proisagg",.viscondition = "pg_catalog.pg_function_is_visible(p.oid)",.namespace = "p.pronamespace",.result = "pg_catalog.quote_ident(p.proname)",}};

static const SchemaQuery Query_for_list_of_datatypes = {
    .catname = "pg_catalog.pg_type t",/* selcondition --- ignore table rowtypes and array types */
    .selcondition = "(t.typrelid = 0  OR (SELECT c.relkind = " CppAsString2(RELKIND_COMPOSITE_TYPE) "     FROM pg_catalog.pg_class c WHERE c.oid = t.typrelid)) AND t.typname !~ '^_'",.viscondition = "pg_catalog.pg_type_is_visible(t.oid)",.namespace = "t.typnamespace",.result = "pg_catalog.format_type(t.oid, NULL)",.qualresult = "pg_catalog.quote_ident(t.typname)",};

static const SchemaQuery Query_for_list_of_composite_datatypes = {
    .catname = "pg_catalog.pg_type t",/* selcondition --- only get composite types */
    .selcondition = "(SELECT c.relkind = " CppAsString2(RELKIND_COMPOSITE_TYPE) " FROM pg_catalog.pg_class c WHERE c.oid = t.typrelid) AND t.typname !~ '^_'",.viscondition = "pg_catalog.pg_type_is_visible(t.oid)",.namespace = "t.typnamespace",.result = "pg_catalog.format_type(t.oid, NULL)",.qualresult = "pg_catalog.quote_ident(t.typname)",};

static const SchemaQuery Query_for_list_of_domains = {
    .catname = "pg_catalog.pg_type t",.selcondition = "t.typtype = 'd'",.viscondition = "pg_catalog.pg_type_is_visible(t.oid)",.namespace = "t.typnamespace",.result = "pg_catalog.quote_ident(t.typname)",};

/* Note: this intentionally accepts aggregates as well as plain functions */
static const SchemaQuery Query_for_list_of_functions[] = {{
                                                              .min_server_version = 110000,.catname = "pg_catalog.pg_proc p",.selcondition = "p.prokind != 'p'",.viscondition = "pg_catalog.pg_function_is_visible(p.oid)",.namespace = "p.pronamespace",.result = "pg_catalog.quote_ident(p.proname)",},{
        .catname = "pg_catalog.pg_proc p",.viscondition = "pg_catalog.pg_function_is_visible(p.oid)",.namespace = "p.pronamespace",.result = "pg_catalog.quote_ident(p.proname)",}};
...
static const SchemaQuery Query_for_list_of_sequences = {
    .catname = "pg_catalog.pg_class c",.selcondition = "c.relkind IN (" CppAsString2(RELKIND_SEQUENCE) ")",.viscondition = "pg_catalog.pg_table_is_visible(c.oid)",.namespace = "c.relnamespace",.result = "pg_catalog.quote_ident(c.relname)",};

static const SchemaQuery Query_for_list_of_foreign_tables = {
    .catname = "pg_catalog.pg_class c",.selcondition = "c.relkind IN (" CppAsString2(RELKIND_FOREIGN_TABLE) ")",.viscondition = "pg_catalog.pg_table_is_visible(c.oid)",.namespace = "c.relnamespace",.result = "pg_catalog.quote_ident(c.relname)",};

static const SchemaQuery Query_for_list_of_tables = {
    .catname = "pg_catalog.pg_class c",.selcondition = "c.relkind IN (" CppAsString2(RELKIND_RELATION) ", " CppAsString2(RELKIND_PARTITIONED_TABLE) ")",.viscondition = "pg_catalog.pg_table_is_visible(c.oid)",.namespace = "c.relnamespace",.result = "pg_catalog.quote_ident(c.relname)",};

static const SchemaQuery Query_for_list_of_partitioned_tables = {
    .catname = "pg_catalog.pg_class c",.selcondition = "c.relkind IN (" CppAsString2(RELKIND_PARTITIONED_TABLE) ")",.viscondition = "pg_catalog.pg_table_is_visible(c.oid)",.namespace = "c.relnamespace",.result = "pg_catalog.quote_ident(c.relname)",};

static const SchemaQuery Query_for_list_of_views = {
    .catname = "pg_catalog.pg_class c",.selcondition = "c.relkind IN (" CppAsString2(RELKIND_VIEW) ")",.viscondition = "pg_catalog.pg_table_is_visible(c.oid)",.namespace = "c.relnamespace",.result = "pg_catalog.quote_ident(c.relname)",};

static const SchemaQuery Query_for_list_of_matviews = {
    .catname = "pg_catalog.pg_class c",.selcondition = "c.relkind IN (" CppAsString2(RELKIND_MATVIEW) ")",.viscondition = "pg_catalog.pg_table_is_visible(c.oid)",.namespace = "c.relnamespace",.result = "pg_catalog.quote_ident(c.relname)",};

static const SchemaQuery Query_for_list_of_indexes = {
    .catname = "pg_catalog.pg_class c",.selcondition = "c.relkind IN (" CppAsString2(RELKIND_INDEX) ", " CppAsString2(RELKIND_PARTITIONED_INDEX) ")",.viscondition = "pg_catalog.pg_table_is_visible(c.oid)",.namespace = "c.relnamespace",.result = "pg_catalog.quote_ident(c.relname)",};

static const SchemaQuery Query_for_list_of_partitioned_indexes = {
    .catname = "pg_catalog.pg_class c",.selcondition = "c.relkind = " CppAsString2(RELKIND_PARTITIONED_INDEX),.viscondition = "pg_catalog.pg_table_is_visible(c.oid)",.namespace = "c.relnamespace",.result = "pg_catalog.quote_ident(c.relname)",};

/* All relations */
static const SchemaQuery Query_for_list_of_relations = {
    .catname = "pg_catalog.pg_class c",.viscondition = "pg_catalog.pg_table_is_visible(c.oid)",.namespace = "c.relnamespace",.result = "pg_catalog.quote_ident(c.relname)",};

/* partitioned relations */
static const SchemaQuery Query_for_list_of_partitioned_relations = {
    .catname = "pg_catalog.pg_class c",.selcondition = "c.relkind IN (" CppAsString2(RELKIND_PARTITIONED_TABLE) ", " CppAsString2(RELKIND_PARTITIONED_INDEX) ")",.viscondition = "pg_catalog.pg_table_is_visible(c.oid)",.namespace = "c.relnamespace",.result = "pg_catalog.quote_ident(c.relname)",};

/* Relations supporting INSERT, UPDATE or DELETE */
static const SchemaQuery Query_for_list_of_updatables = {
    .catname = "pg_catalog.pg_class c",.selcondition = "c.relkind IN (" CppAsString2(RELKIND_RELATION) ", " CppAsString2(RELKIND_FOREIGN_TABLE) ", " CppAsString2(RELKIND_VIEW) ", " CppAsString2(RELKIND_PARTITIONED_TABLE) ")",.viscondition = "pg_catalog.pg_table_is_visible(c.oid)",.namespace = "c.relnamespace",.result = "pg_catalog.quote_ident(c.relname)",};
...
static const SchemaQuery Query_for_list_of_indexables = {
    .catname = "pg_catalog.pg_class c",.selcondition = "c.relkind IN (" CppAsString2(RELKIND_RELATION) ", " CppAsString2(RELKIND_PARTITIONED_TABLE) ", " CppAsString2(RELKIND_MATVIEW) ")",.viscondition = "pg_catalog.pg_table_is_visible(c.oid)",.namespace = "c.relnamespace",.result = "pg_catalog.quote_ident(c.relname)",};

/* Relations supporting VACUUM */
static const SchemaQuery Query_for_list_of_vacuumables = {
    .catname = "pg_catalog.pg_class c",.selcondition = "c.relkind IN (" CppAsString2(RELKIND_RELATION) ", " CppAsString2(RELKIND_MATVIEW) ")",.viscondition = "pg_catalog.pg_table_is_visible(c.oid)",.namespace = "c.relnamespace",.result = "pg_catalog.quote_ident(c.relname)",};
...
static const SchemaQuery Query_for_list_of_constraints_with_schema = {
    .catname = "pg_catalog.pg_constraint c",.selcondition = "c.conrelid <> 0",.viscondition = "true", /* there is no pg_constraint_is_visible */
    .namespace = "c.connamespace",.result = "pg_catalog.quote_ident(c.conname)",};

static const SchemaQuery Query_for_list_of_statistics = {
    .catname = "pg_catalog.pg_statistic_ext s",.viscondition = "pg_catalog.pg_statistics_obj_is_visible(s.oid)",.namespace = "s.stxnamespace",.result = "pg_catalog.quote_ident(s.stxname)",};

/*
 * Queries to get lists of names of various kinds of things, possibly
 * restricted to names matching a partially entered name.  In these queries,* the first %s will be replaced by the text entered so far (suitably escaped
...
#define Query_for_list_of_encodings                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    \
  ...
  "  WHERE "                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           \
  "substring(pg_catalog.pg_encoding_to_char(conforencoding),1,%d)=UPPER('%s')"
...
#define Query_for_index_of_table                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       \
  ...
  "  FROM pg_catalog.pg_class c1, pg_catalog.pg_class c2, "                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            \
...
#define Query_for_list_of_available_extensions                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         \
  ...
  "  WHERE substring(pg_catalog.quote_ident(name),1,%d)='%s' AND "                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     \
...
static const VersionedQuery Query_for_list_of_publications[] = {{100000, " SELECT pg_catalog.quote_ident(pubname)    FROM pg_catalog.pg_publication   WHERE substring(pg_catalog.quote_ident(pubname),1,%d)='%s'"},{0, NULL}};

static const VersionedQuery Query_for_list_of_subscriptions[] = {{100000, " SELECT pg_catalog.quote_ident(s.subname)    FROM pg_catalog.pg_subscription s, pg_catalog.pg_database d   WHERE substring(pg_catalog.quote_ident(s.subname),1,%d)='%s'     AND d.datname = pg_catalog.current_database()     AND s.subdbid = d.oid"},{0, NULL}};
...
/*
 * Check if 'word' matches any of the '|'-separated strings in 'pattern',* using case-insensitive or case-sensitive comparisons.
 *
...
#define HeadMatchesCS(...) HeadMatchesImpl(true, previous_words_count, previous_words, VA_ARGS_NARGS(__VA_ARGS__), __VA_ARGS__)
  ...
  /*
   * If we have ALTER TABLE <sth> ALTER|DROP|RENAME|VALIDATE CONSTRAINT,* provide list of constraints
   */
   ...
   */
    ...
    COMPLETE_WITH_SCHEMA_QUERY(Query_for_list_of_indexes, " UNION SELECT 'ON' UNION SELECT 'CONCURRENTLY'");
  }
  ...
  else if (Matches("DROP","COLLATION|CONVERSION|DOMAIN|EXTENSION|LANGUAGE|PUBLICATION|SCHEMA|SEQUENCE|SERVER|SUBSCRIPTION|STATISTICS|TABLE|TYPE|VIEW",MatchAny) ||
           Matches("DROP", "ACCESS", "METHOD", MatchAny) || (Matches("DROP", "AGGREGATE|FUNCTION|PROCEDURE|ROUTINE", MatchAny, MatchAny) && ends_with(prev_wd, ')')) || Matches("DROP", "EVENT", "TRIGGER", MatchAny) || Matches("DROP", "FOREIGN", "DATA", "WRAPPER", MatchAny) || Matches("DROP", "FOREIGN", "TABLE", MatchAny) || Matches("DROP", "TEXT", "SEARCH", "CONFIGURATION|DICTIONARY|PARSER|TEMPLATE", MatchAny)) {
  ...
  /*
   * Complete FETCH <sth1> <sth2> with "FROM" or "IN". These are equivalent,* but we may as well tab-complete both: perhaps some users prefer one
  ...
  /* Complete GRANT/REVOKE with a list of roles and privileges */
    ...
    if (HeadMatches("ALTER", "DEFAULT", "PRIVILEGES")) {
      ...
      COMPLETE_WITH_QUERY(Query_for_list_of_roles " UNION SELECT 'SELECT' UNION SELECT 'INSERT' UNION SELECT 'UPDATE' UNION SELECT 'DELETE' UNION SELECT 'TRUNCATE' UNION SELECT 'REFERENCES' UNION SELECT 'TRIGGER' UNION SELECT 'CREATE' UNION SELECT 'CONNECT' UNION SELECT 'TEMPORARY' UNION SELECT 'EXECUTE' UNION SELECT 'USAGE' UNION SELECT 'ALL'");
    }
  }
   ...
   */
    ...
    if (HeadMatches("ALTER", "DEFAULT", "PRIVILEGES")) {
      ...
      COMPLETE_WITH_SCHEMA_QUERY(Query_for_list_of_grantables, " UNION SELECT 'ALL FUNCTIONS IN SCHEMA' UNION SELECT 'ALL PROCEDURES IN SCHEMA' UNION SELECT 'ALL ROUTINES IN SCHEMA' UNION SELECT 'ALL SEQUENCES IN SCHEMA' UNION SELECT 'ALL TABLES IN SCHEMA' UNION SELECT 'DATABASE' UNION SELECT 'DOMAIN' UNION SELECT 'FOREIGN DATA WRAPPER' UNION SELECT 'FOREIGN SERVER' UNION SELECT 'FUNCTION' UNION SELECT 'LANGUAGE' UNION SELECT 'LARGE OBJECT' UNION SELECT 'PROCEDURE' UNION SELECT 'ROUTINE' UNION SELECT 'SCHEMA' UNION SELECT 'SEQUENCE' UNION SELECT 'TABLE' UNION SELECT 'TABLESPACE' UNION SELECT 'TYPE'");
    }
  ...
  /*
   * Complete "GRANT/REVOKE ... TO/FROM" with username, PUBLIC,* CURRENT_USER, or SESSION_USER.
   */
   ...
   */
    ...
    if (TailMatches("DateStyle", "TO|=")) {
      ...
      COMPLETE_WITH_QUERY(Query_for_list_of_schemas " AND nspname not like 'pg\\_toast%%'  AND nspname not like 'pg\\_temp%%'  UNION SELECT 'DEFAULT' ");
    } else {
  ...
  /* USER MAPPING */
    ...
    COMPLETE_WITH_QUERY(Query_for_list_of_roles " UNION SELECT 'CURRENT_USER' UNION SELECT 'PUBLIC' UNION SELECT 'USER'");
   ...
   */
    ...
    COMPLETE_WITH_SCHEMA_QUERY(Query_for_list_of_vacuumables, " UNION SELECT 'FULL' UNION SELECT 'FREEZE' UNION SELECT 'ANALYZE' UNION SELECT 'VERBOSE'");
  } else if (Matches("VACUUM", "FULL")) {
    COMPLETE_WITH_SCHEMA_QUERY(Query_for_list_of_vacuumables, " UNION SELECT 'FREEZE' UNION SELECT 'ANALYZE' UNION SELECT 'VERBOSE'");
  } else if (Matches("VACUUM", "FREEZE") || Matches("VACUUM", "FULL", "FREEZE")) {
    COMPLETE_WITH_SCHEMA_QUERY(Query_for_list_of_vacuumables, " UNION SELECT 'VERBOSE' UNION SELECT 'ANALYZE'");
  ...
  /* must be at end of \d alternatives: */
    ...
    } else if (TailMatchesCS("unicode_border_linestyle|unicode_column_linestyle|unicode_header_linestyle")) {
    ...
    if (TailMatchesCS("AUTOCOMMIT|ON_ERROR_STOP|QUIET|SINGLELINE|SINGLESTEP")) {
    ...
    COMPLETE_WITH_SCHEMA_QUERY(Query_for_list_of_views, NULL);
  } else if (TailMatchesCS("\\cd|\\e|\\edit|\\g|\\gx|\\i|\\include|\\ir|\\include_relative|\\o|\\out|\\s|\\w|\\write|\\lo_import")) {
    completion_charp = "\\";
    matches = completion_matches(text, complete_from_files);
  }
  ...
  if (state == 0) {
    ...
    if (schema_query) {
      ...
      if (strcmp(schema_query->catname, "pg_catalog.pg_class c") == 0 && strncmp(text, "pg_", 3) != 0) {
        appendPQExpBufferStr(&query_buffer, " AND c.relnamespace <> (SELECT oid FROM pg_catalog.pg_namespace WHERE nspname = 'pg_catalog')");
      }
       ...
       */
      appendPQExpBuffer(&query_buffer,"\nUNION\nSELECT pg_catalog.quote_ident(n.nspname) || '.' FROM pg_catalog.pg_namespace n WHERE substring(pg_catalog.quote_ident(n.nspname) || '.',1,%d)='%s'",char_length, e_text);
      appendPQExpBuffer(&query_buffer," AND (SELECT pg_catalog.count(*) FROM pg_catalog.pg_namespace WHERE substring(pg_catalog.quote_ident(nspname) || '.',1,%d) = substring('%s',1,pg_catalog.length(pg_catalog.quote_ident(nspname))+1)) > 1",char_length, e_text);

      /*
       * Add in matching qualified names, but only if there is exactly
       * one schema matching the input-so-far.
       */
      appendPQExpBuffer(&query_buffer,"\nUNION\nSELECT pg_catalog.quote_ident(n.nspname) || '.' || %s FROM %s, pg_catalog.pg_namespace n WHERE %s = n.oid AND ",qualresult, schema_query->catname, schema_query->namespace);
      if (schema_query->selcondition) {
        appendPQExpBuffer(&query_buffer, "%s AND ", schema_query->selcondition);
      }
       ...
       * speed up the query
       */
      appendPQExpBuffer(&query_buffer," AND substring(pg_catalog.quote_ident(n.nspname) || '.',1,%d) = substring('%s',1,pg_catalog.length(pg_catalog.quote_ident(n.nspname))+1)",char_length, e_text);
      appendPQExpBuffer(&query_buffer," AND (SELECT pg_catalog.count(*) FROM pg_catalog.pg_namespace WHERE substring(pg_catalog.quote_ident(nspname) || '.',1,%d) = substring('%s',1,pg_catalog.length(pg_catalog.quote_ident(nspname))+1)) = 1",char_length, e_text);
  ...
  while ((item = completion_charpp[list_index++])) {
    ...
    if (!casesensitive && pg_strncasecmp(text, item, string_length) == 0) {
      if (completion_case_sensitive) {
        ...
        /*
         * If case insensitive matching was requested initially,* adjust the case according to setting.
         */
 ...
 * completely certain that we know what must appear at a certain spot,* so that it's okay to overwrite misspellings.  In practice, given the
 ...
 *
 * Returns NULL if the variable is unknown. Otherwise the returned string,* containing the type, has to be freed.
 */
static char *
get_guctype(const char *varname)
{
  ...
  initPQExpBuffer(&query_buffer);
  appendPQExpBuffer(&query_buffer,"SELECT vartype FROM pg_catalog.pg_settings WHERE pg_catalog.lower(name) = pg_catalog.lower('%s')",e_varname);
