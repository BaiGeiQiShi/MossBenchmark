...
plpython_inline_handler(PG_FUNCTION_ARGS)
{
  ...
  proc.mcxt = AllocSetContextCreate(TopMemoryContext, "__plpython_inline_block", ALLOCSET_DEFAULT_SIZES);
...
PLy_push_execution_context(bool atomic_context)
{
  ...
  context = (PLyExecutionContext *)MemoryContextAlloc(atomic_context ? TopTransactionContext : PortalContext, sizeof(PLyExecutionContext));
