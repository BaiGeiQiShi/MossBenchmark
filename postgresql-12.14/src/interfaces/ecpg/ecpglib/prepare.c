 ...
 * having stmtCacheEntPerBucket entries, which we recycle as needed,* giving up the least-executed entry in the bucket.
...
/* questionmarks is not needed but remains in there for the time being to not
 * change the API */
bool
