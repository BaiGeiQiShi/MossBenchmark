...
static const datetkn datetktbl[] = {
    ...
    {"am", AMPM, AM}, {"amst", DTZ, 18000}, /* Armenia Summer Time (Yerevan) */
#if 0
    ...
    {"aug", MONTH, 8}, {"august", MONTH, 8}, {"awsst", DTZ, 32400}, /* W. Australia */
    {"awst", TZ, 28800},                                            /* W. Australia */
    {"awt", DTZ, -10800}, {"azost", DTZ, 0},                        /* Azores Summer Time */
    ...
    {"dec", MONTH, 12}, {"december", MONTH, 12}, {"dnt", TZ, 3600}, /* Dansk Normal Tid */
    ...
    {"feb", MONTH, 2}, {"february", MONTH, 2}, {"fjst", DTZ, -46800}, /* Fiji Summer Time (13 hour offset!) */
	...
	fnt
#endif
    {"fri", DOW, 5}, {"friday", DOW, 5}, {"fst", TZ, 3600}, /* French Summer Time */
    ...
    {"j", UNITS, DTK_JULIAN}, {"jan", MONTH, 1}, {"january", MONTH, 1}, {"javt", TZ, 25200},                                          /* Java Time (07:00? see JT) */
    {"jayt", TZ, 32400},                                                                                                              /* Jayapura Time (Indonesia) */
    {"jd", UNITS, DTK_JULIAN}, {"jst", TZ, 32400},                                                                                    /* Japan Std Time,USSR Zone 8 */
    {"jt", TZ, 27000},                                                                                                                /* Java Time (07:30? see JAVT) */
    {"jul", MONTH, 7}, {"julian", UNITS, DTK_JULIAN}, {"july", MONTH, 7}, {"jun", MONTH, 6}, {"june", MONTH, 6}, {"kdt", DTZ, 36000}, /* Korea Daylight Time */
    ...
    {"mar", MONTH, 3}, {"march", MONTH, 3}, {"mart", TZ, -34200},                                                                     /* Marquesas Time */
    {"mawt", TZ, 21600},                                                                                                              /* Mawson, Antarctica */
    {"may", MONTH, 5}, {"mdt", DTZ, -21600},                                                                                          /* Mountain Daylight Time */
    ...
    {"nov", MONTH, 11}, {"november", MONTH, 11}, {"novst", DTZ, 25200}, /* Novosibirsk Summer Time */
    ...
    {"oct", MONTH, 10}, {"october", MONTH, 10}, {"omsst", DTZ, 25200},  /* Omsk Summer Time */
    ...
    {"pm", AMPM, PM}, {"pmdt", DTZ, -7200}, /* Pierre & Miquelon Daylight Time */
#if 0
	pmst
#endif
    ...
    {"sep", MONTH, 9}, {"sept", MONTH, 9}, {"september", MONTH, 9}, {"set", TZ, -3600}, /* Seychelles Time ?? */
#if 0
	sgt
#endif
    {"sst", DTZ, 7200},                                     /* Swedish Summer Time */
    {"sun", DOW, 0}, {"sunday", DOW, 0}, {"swt", TZ, 3600}, /* Swedish Winter Time */
#if 0
	syot
#endif
    ...
    {"thu", DOW, 4}, {"thur", DOW, 4}, {"thurs", DOW, 4}, {"thursday", DOW, 4}, {"tjt", TZ, 18000}, /* Tajikistan Time */
    ...
    {"tue", DOW, 2}, {"tues", DOW, 2}, {"tuesday", DOW, 2}, {"tvt", TZ, 43200}, /* Tuvalu Time */
#if 0
	uct
#endif
    {"ulast", DTZ, 32400},                               /* Ulan Bator Summer Time */
    {"ulat", TZ, 28800},                                 /* Ulan Bator Time */
    {"ut", TZ, 0}, {"utc", TZ, 0}, {"uyst", DTZ, -7200}, /* Uruguay Summer Time */
    ...
    {"wed", DOW, 3}, {"wednesday", DOW, 3}, {"weds", DOW, 3}, {"west", DTZ, 3600}, /* Western Europe Summer Time */
