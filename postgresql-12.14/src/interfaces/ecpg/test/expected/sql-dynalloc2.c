...
#line 32 "dynalloc2.pgc"
  ...
  {
    ECPGdo(__LINE__, 0, 1, NULL, 0, ECPGst_normal, "select * from test", ECPGt_EOIT, ECPGt_descriptor, "mydesc", 1L, 1L, 1L, ECPGt_NO_INDICATOR, NULL, 0L, 0L, 0L, ECPGt_EORT);
...
#line 34 "dynalloc2.pgc"
  ...
  {
    ECPGget_desc(__LINE__, "mydesc", 1, ECPGd_indicator, ECPGt_int, &(ipointer1), (long)1, (long)0, sizeof(int), ECPGd_data, ECPGt_int, &(ip1), (long)1, (long)0, sizeof(int), ECPGd_EODT);
...
#line 35 "dynalloc2.pgc"
  ...
  {
    ECPGget_desc(__LINE__, "mydesc", 2, ECPGd_indicator, ECPGt_int, &(ipointer2), (long)1, (long)0, sizeof(int), ECPGd_data, ECPGt_char, &(cp2), (long)0, (long)0, (1) * sizeof(char), ECPGd_EODT);
