...
#line 23 "autoprep.pgc"
  ...
  {
    ECPGdo(__LINE__, 0, 1, NULL, 0, ECPGst_prepnormal, "insert into T values ( 1 , $1  )", ECPGt_int, &(i), (long)1, (long)1, sizeof(int), ECPGt_NO_INDICATOR, NULL, 0L, 0L, 0L, ECPGt_EOIT, ECPGt_EORT);
...
#line 28 "autoprep.pgc"
  ...
  {
    ECPGdo(__LINE__, 0, 1, NULL, 0, ECPGst_prepnormal, "select Item2 from T order by Item2 nulls last", ECPGt_EOIT, ECPGt_int, (item), (long)1, (long)4, sizeof(int), ECPGt_int, (ind), (long)1, (long)4, sizeof(int), ECPGt_EORT);
...
#line 37 "autoprep.pgc"
  ...
  {
    ECPGdo(__LINE__, 0, 1, NULL, 0, ECPGst_normal, "fetch 1 in C", ECPGt_EOIT, ECPGt_int, &(i), (long)1, (long)1, sizeof(int), ECPGt_NO_INDICATOR, NULL, 0L, 0L, 0L, ECPGt_EORT);
...
#line 46 "autoprep.pgc"
  ...
  {
    ECPGdo(__LINE__, 0, 1, NULL, 0, ECPGst_normal, "declare cur1 cursor for $1", ECPGt_char_variable, (ECPGprepared_statement(NULL, "stmt1", __LINE__)), (long)1, (long)1, (1) * sizeof(char), ECPGt_NO_INDICATOR, NULL, 0L, 0L, 0L, ECPGt_EOIT, ECPGt_EORT);
...
#line 50 "autoprep.pgc"
  ...
  {
    {
      ECPGdo(__LINE__, 0, 1, NULL, 0, ECPGst_normal, "fetch cur1", ECPGt_EOIT, ECPGt_int, &(item1), (long)1, (long)1, sizeof(int), ECPGt_int, &(ind1), (long)1, (long)1, sizeof(int), ECPGt_EORT);
