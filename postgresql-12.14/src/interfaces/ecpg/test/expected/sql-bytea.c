...
#define init()                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         \
  {                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    \
    ...
    recv_vlen_buf = NULL, memset(recv_short_buf.arr, 0x0, sizeof(recv_short_buf.arr));                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 \
  }                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    \
  while (0)
...
#line 105 "bytea.pgc"
  ...
  {
    ECPGset_desc(__LINE__, "idesc", 1, ECPGd_data, ECPGt_bytea, &(send_buf[0]), (long)512, (long)1, sizeof(struct bytea_1), ECPGd_EODT);
...
#line 106 "bytea.pgc"
  ...
  {
    ECPGset_desc(__LINE__, "idesc", 2, ECPGd_data, ECPGt_bytea, &(send_buf[1]), (long)512, (long)1, sizeof(struct bytea_1), ECPGd_EODT);
...
#line 109 "bytea.pgc"
  ...
  {
    ECPGget_desc(__LINE__, "odesc", 1, ECPGd_indicator, ECPGt_int, &(ind[0]), (long)1, (long)1, sizeof(int), ECPGd_data, ECPGt_bytea, &(recv_buf[0]), (long)DATA_SIZE, (long)1, sizeof(struct bytea_2), ECPGd_EODT);
...
#line 110 "bytea.pgc"
  ...
  {
    ECPGget_desc(__LINE__, "odesc", 2, ECPGd_indicator, ECPGt_int, &(ind[1]), (long)1, (long)1, sizeof(int), ECPGd_data, ECPGt_bytea, &(recv_short_buf), (long)DATA_SIZE - LACK_SIZE, (long)1, sizeof(struct bytea_4), ECPGd_EODT);
