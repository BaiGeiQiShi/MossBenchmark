...
#line 42 "dynalloc.pgc"
  ...
  {
    ECPGget_desc(__LINE__, "mydesc", 1, ECPGd_indicator, ECPGt_int, &(i1), (long)1, (long)0, sizeof(int), ECPGd_data, ECPGt_int, &(d1), (long)1, (long)0, sizeof(int), ECPGd_EODT);
...
#line 43 "dynalloc.pgc"
  ...
  {
    ECPGget_desc(__LINE__, "mydesc", 2, ECPGd_indicator, ECPGt_int, &(i2), (long)1, (long)0, sizeof(int), ECPGd_data, ECPGt_double, &(d2), (long)1, (long)0, sizeof(double), ECPGd_EODT);
...
#line 44 "dynalloc.pgc"
  ...
  {
    ECPGget_desc(__LINE__, "mydesc", 3, ECPGd_indicator, ECPGt_int, &(i3), (long)1, (long)0, sizeof(int), ECPGd_data, ECPGt_char, &(d3), (long)0, (long)0, (1) * sizeof(char), ECPGd_EODT);
...
#line 45 "dynalloc.pgc"
  ...
  {
    ECPGget_desc(__LINE__, "mydesc", 4, ECPGd_indicator, ECPGt_int, &(i4), (long)1, (long)0, sizeof(int), ECPGd_data, ECPGt_char, &(d4), (long)0, (long)0, (1) * sizeof(char), ECPGd_EODT);
...
#line 46 "dynalloc.pgc"
  ...
  {
    ECPGget_desc(__LINE__, "mydesc", 5, ECPGd_indicator, ECPGt_int, &(i5), (long)1, (long)0, sizeof(int), ECPGd_data, ECPGt_char, &(d5), (long)0, (long)0, (1) * sizeof(char), ECPGd_EODT);
...
#line 47 "dynalloc.pgc"
  ...
  {
    ECPGget_desc(__LINE__, "mydesc", 6, ECPGd_indicator, ECPGt_int, &(i6), (long)1, (long)0, sizeof(int), ECPGd_data, ECPGt_char, &(d6), (long)0, (long)0, (1) * sizeof(char), ECPGd_EODT);
...
#line 48 "dynalloc.pgc"
  ...
  {
    ECPGget_desc(__LINE__, "mydesc", 7, ECPGd_indicator, ECPGt_int, &(i7), (long)1, (long)0, sizeof(int), ECPGd_data, ECPGt_char, &(d7), (long)0, (long)0, (1) * sizeof(char), ECPGd_EODT);
...
#line 49 "dynalloc.pgc"
  ...
  {
    ECPGget_desc(__LINE__, "mydesc", 9, ECPGd_indicator, ECPGt_int, &(i9), (long)1, (long)0, sizeof(int), ECPGd_data, ECPGt_char, &(d9), (long)0, (long)0, (1) * sizeof(char), ECPGd_EODT);
