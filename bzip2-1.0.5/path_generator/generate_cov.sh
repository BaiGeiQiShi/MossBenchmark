...
# handle error gcovs
cp -r $CURRDIR/errorgcovs/* $CURRDIR/tmp/bin.gcov
...
${COV}/bin/gcovbasedcoderemover $PROGRAM.c $CURRDIR/path_generator/line.txt merged.bin.gcov false > ${PROGRAM}.c.cov.origin.c
